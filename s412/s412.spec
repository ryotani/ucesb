...
// Needed for POS sampler etc.
  vme_master = MASTER_VME(type = SUBEVENT_VME, subtype = SUBEVENT_VME_DATA8800,subcrate=4, control=1);
//
  ...
  vme_cbr  = CB_VME_RIGHT(type = SUBEVENT_VME, subtype = SUBEVENT_VME_DATA8800,subcrate=3);
  vme_cbl  = CB_VME_LEFT( type = SUBEVENT_VME, subtype = SUBEVENT_VME_DATA8800,subcrate=4, control=5);
...
SIGNAL(ZERO_SUPPRESS: XB1);       // Make XB values appear as array
