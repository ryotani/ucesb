...
EVENT
{
  ...
  vme1     = VME_CRATE1(type = SUBEVENT_VME, subtype = SUBEVENT_VME_DATA8800,control=5,subcrate=1);
  vme2     = VME_CRATE2(type = SUBEVENT_VME, subtype = SUBEVENT_VME_DATA8800,control=5,subcrate=2);

  vme_cbr  = CB_VME_RIGHT(type = SUBEVENT_VME, subtype = SUBEVENT_VME_DATA8800,control=5,subcrate=3);
  vme_cbl  = CB_VME_LEFT (type = SUBEVENT_VME, subtype = SUBEVENT_VME_DATA8800,control=5,subcrate=4);

  vme_master = MASTER_VME(type = SUBEVENT_VME, subtype = SUBEVENT_VME_DATA8800,subcrate=6);
  ...
  tacquila = TACQUILA_LAND_SUBEVENT   (type=94,subtype=9400,subcrate=0);
  neuland  = TACQUILA_NEULAND_SUBEVENT(type=94,subtype=9400,subcrate=1);

  ignore_unknown_subevent;
}

#include "mapping.hh"
#include "xb_mapping.hh"
// #include "mfi_mapping.hh"
