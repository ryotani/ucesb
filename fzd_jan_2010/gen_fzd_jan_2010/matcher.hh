...
bool FZD_data_SUBITEM::__match(__data_src_t &__buffer,uint32 geo)
{
  ...
  MATCH_BITS_RANGE_MAX(17,ch_data.channel,32);
  MATCH_BITS_EQUAL(16,ch_data.unnamed_29_29,0);
  MATCH_BITS_EQUAL(15,ch_data.unnamed_30_30,0);
  MATCH_BITS_EQUAL(14,ch_data.unnamed_31_31,0);
  return true;
  return false;
}
...
bool FZD_Modul::__match(__data_src_t &__buffer,uint32 geom)
{
  ...
  READ_FROM_BUFFER_FULL(27,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(27,__header.unnamed_0_23,0);
  MATCH_BITS_EQUAL(27,__header.geom,geom);
  MATCH_BITS_EQUAL(27,__header.unnamed_29_29,1);
  MATCH_BITS_EQUAL(27,__header.unnamed_30_30,0);
  MATCH_BITS_EQUAL(27,__header.unnamed_31_31,0);
  return true;
  return false;
}
...
bool FZD_V1495::__match(__data_src_t &__buffer,uint32 geom)
{
  ...
  READ_FROM_BUFFER_FULL(40,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(40,__header.unnamed_0_23,0);
  MATCH_BITS_EQUAL(40,__header.geom,geom);
  MATCH_BITS_EQUAL(40,__header.unnamed_29_29,1);
  MATCH_BITS_EQUAL(40,__header.unnamed_30_30,0);
  MATCH_BITS_EQUAL(40,__header.unnamed_31_31,0);
  return true;
  return false;
}
