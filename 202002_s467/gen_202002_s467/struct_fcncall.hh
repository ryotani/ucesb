...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(VME_SIS_3820_SCALER)::FCNCALL_NAME(VME_SIS_3820_SCALER)
{
  FCNCALL_INIT;
  // raw_array_zero_suppress<DATA32,DATA32,32> data;
  {
...
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(sofia_tof_subev_data)::FCNCALL_NAME(sofia_tof_subev_data)
{
  ...
  // VME_SIS_3820_SCALER sis3820scaler[2];
  {
  FCNCALL_SUBNAME("sis3820scaler");
  FCNCALL_FOR(__i0,2)
  {
    FCNCALL_SUBINDEX(__i0);
    { FCNCALL_CALL_CTRL_WRAP_ARRAY(sis3820scaler__i0,,__i0,sis3820scaler[__i0].FCNCALL_CALL(sis3820scaler[__i0])); }
    FCNCALL_SUBINDEX_END(__i0);
  }
  FCNCALL_SUBNAME_END;
  }
...
{
  FCNCALL_INIT;
  // VME_SIS_3820_SCALER sis3820scaler;
  {
  FCNCALL_SUBNAME("sis3820scaler");
  { FCNCALL_CALL_CTRL_WRAP(sis3820scaler,sis3820scaler.FCNCALL_CALL(sis3820scaler)); }
  FCNCALL_SUBNAME_END;
  }
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(CALIFA_MESSEL)::FCNCALL_NAME(CALIFA_MESSEL)
{
  FCNCALL_INIT;
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(CALIFA_WIXHAUSEN)::FCNCALL_NAME(CALIFA_WIXHAUSEN)
{
  FCNCALL_INIT;
  FCNCALL_CALL_CTRL_WRAP(unpack_subevent_base,FCNCALL_CLASS_NAME(unpack_subevent_base)::FCNCALL_CALL_BASE());
  // FEBEX3_CALIFA_BASE febex3;
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(main_tpat_subev)::FCNCALL_NAME(main_tpat_subev)
{
  FCNCALL_INIT;
  FCNCALL_CALL_CTRL_WRAP(unpack_subevent_base,FCNCALL_CLASS_NAME(unpack_subevent_base)::FCNCALL_CALL_BASE());
  // TRLOII_TPAT tpat;
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(main_wr)::FCNCALL_NAME(main_wr)
{
  FCNCALL_INIT;
  FCNCALL_CALL_CTRL_WRAP(unpack_subevent_base,FCNCALL_CLASS_NAME(unpack_subevent_base)::FCNCALL_CALL_BASE());
  // TIMESTAMP_WHITERABBIT ts;
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(sofia_sampler_subev)::FCNCALL_NAME(sofia_sampler_subev)
{
  FCNCALL_INIT;
  FCNCALL_CALL_CTRL_WRAP(unpack_subevent_base,FCNCALL_CLASS_NAME(unpack_subevent_base)::FCNCALL_CALL_BASE());
  // TRLOII_SAMPLER sofstart;
  {
  FCNCALL_SUBNAME("sofstart");
  { FCNCALL_CALL_CTRL_WRAP(sofstart,sofstart.FCNCALL_CALL(sofstart)); }
  FCNCALL_SUBNAME_END;
  }
  // TRLOII_SAMPLER ms;
  {
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(sofia_wr)::FCNCALL_NAME(sofia_wr)
{
  FCNCALL_INIT;
  FCNCALL_CALL_CTRL_WRAP(unpack_subevent_base,FCNCALL_CLASS_NAME(unpack_subevent_base)::FCNCALL_CALL_BASE());
  // TIMESTAMP_WHITERABBIT ts;
...
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(unpack_event)::FCNCALL_NAME(unpack_event)
{
  ...
  // main_wr main_ts;
  {
  FCNCALL_SUBNAME("main_ts");
  { FCNCALL_CALL_CTRL_WRAP(main_ts,main_ts.FCNCALL_CALL(main_ts)); }
  FCNCALL_SUBNAME_END;
  }
  // sofia_sampler_subev sofia_sampler;
  {
  FCNCALL_SUBNAME("sofia_sampler");
  { FCNCALL_CALL_CTRL_WRAP(sofia_sampler,sofia_sampler.FCNCALL_CALL(sofia_sampler)); }
  FCNCALL_SUBNAME_END;
  }
  // main_tpat_subev main_tpat;
  {
  FCNCALL_SUBNAME("main_tpat");
  { FCNCALL_CALL_CTRL_WRAP(main_tpat,main_tpat.FCNCALL_CALL(main_tpat)); }
  FCNCALL_SUBNAME_END;
  }
  ...
  // CALIFA_MESSEL califa_messel;
  {
  FCNCALL_SUBNAME("califa_messel");
  { FCNCALL_CALL_CTRL_WRAP(califa_messel,califa_messel.FCNCALL_CALL(califa_messel)); }
  FCNCALL_SUBNAME_END;
  }
  // s2_vme_subev s2_vme;
  {
  ...
  // CALIFA_WIXHAUSEN califa_wixhausen;
  {
  FCNCALL_SUBNAME("califa_wixhausen");
  { FCNCALL_CALL_CTRL_WRAP(califa_wixhausen,califa_wixhausen.FCNCALL_CALL(califa_wixhausen)); }
  FCNCALL_SUBNAME_END;
  }
  // sofia_wr sofia_ts;
  {
  FCNCALL_SUBNAME("sofia_ts");
  { FCNCALL_CALL_CTRL_WRAP(sofia_ts,sofia_ts.FCNCALL_CALL(sofia_ts)); }
  FCNCALL_SUBNAME_END;
  }
