...
void PACKER_s2_vme_subev_data::__packer(__data_dest_t &__buffer)
{
  ...
  // barrier = BARRIER();
  PACK_DECL(2113,BARRIER,barrier);
  // vftx21 = VME_GSI_VFTX2(id=1);
  PACK_DECL(2114,VME_GSI_VFTX2,vftx21,/*id*/1);
  // mqdc = VME_MESYTEC_MQDC32(geom=2);
  PACK_DECL(2115,VME_MESYTEC_MQDC32,mqdc,/*geom*/2);
}
...
void PACKER_sofia_wr::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(1949,TIMESTAMP_WHITERABBIT,ts,/*id*/0xe00);
}
