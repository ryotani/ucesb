...
#define EXT_STR_h101_SOFSCI_ITEMS_INFO(ok,si,offset,struct_t,printerr) do { \
  ...
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFSCI3TFMI,                     UINT32,\
                    "SOFSCI3TFMI",                     "SOFSCI3TFM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFSCI3TFME,                     UINT32,\
                    "SOFSCI3TFME",                     "SOFSCI3TFM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFSCI3TF,                       UINT32,\
                    "SOFSCI3TF",300); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFSCI3TFv,                      UINT32,\
                    "SOFSCI3TFv",                      "SOFSCI3TF"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFSCI3TCM,                      UINT32,\
                    "SOFSCI3TCM",3); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFSCI3TCMI,                     UINT32,\
                    "SOFSCI3TCMI",                     "SOFSCI3TCM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFSCI3TCME,                     UINT32,\
                    "SOFSCI3TCME",                     "SOFSCI3TCM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFSCI3TC,                       UINT32,\
                    "SOFSCI3TC",300); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFSCI3TCv,                      UINT32,\
                    "SOFSCI3TCv",                      "SOFSCI3TC"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFSCI4TFM,                      UINT32,\
                    "SOFSCI4TFM",3); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFSCI4TFMI,                     UINT32,\
                    "SOFSCI4TFMI",                     "SOFSCI4TFM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFSCI4TFME,                     UINT32,\
                    "SOFSCI4TFME",                     "SOFSCI4TFM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFSCI4TF,                       UINT32,\
                    "SOFSCI4TF",300); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFSCI4TFv,                      UINT32,\
                    "SOFSCI4TFv",                      "SOFSCI4TF"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFSCI4TCM,                      UINT32,\
                    "SOFSCI4TCM",3); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFSCI4TCMI,                     UINT32,\
                    "SOFSCI4TCMI",                     "SOFSCI4TCM"); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFSCI4TCME,                     UINT32,\
                    "SOFSCI4TCME",                     "SOFSCI4TCM"); \
  EXT_STR_ITEM_INFO_LIM(ok,si,offset,struct_t,printerr,\
                     SOFSCI4TC,                       UINT32,\
                    "SOFSCI4TC",300); \
  EXT_STR_ITEM_INFO_ZZP(ok,si,offset,struct_t,printerr,\
                     SOFSCI4TCv,                      UINT32,\
                    "SOFSCI4TCv",                      "SOFSCI4TC"); \
  \
} while (0);
