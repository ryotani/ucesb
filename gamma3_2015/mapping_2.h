...
/* SIS3316_NOGATES */
#define SIGNAL_SIS3316_CHANNEL_NOGATES(name, id, idm1, ch, chm1)\
...
#else
SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 1, 0,  1,  0)
/*//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 1, 0,  2,  1)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 1, 0,  3,  2)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 1, 0,  4,  3)*/
SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 1, 0,  5,  4)
/*//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 1, 0,  6,  5)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 1, 0,  7,  6)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 1, 0,  8,  7)*/
SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 1, 0,  9,  8)
/*//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 1, 0, 10,  9)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 1, 0, 11, 10)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 1, 0, 12, 11)*/
SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 1, 0, 13, 12)
/*//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 1, 0, 14, 13)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 1, 0, 15, 14)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 1, 0, 16, 15)*/
#endif
...
#else
SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 3, 2,  1,  0)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 3, 2,  2,  1)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 3, 2,  3,  2)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 3, 2,  4,  3)
SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 3, 2,  5,  4)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 3, 2,  6,  5)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 3, 2,  7,  6)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 3, 2,  8,  7)
SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 3, 2,  9,  8)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 3, 2, 10,  9)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 3, 2, 11, 10)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 3, 2, 12, 11)
SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 3, 2, 13, 12)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 3, 2, 14, 13)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 3, 2, 15, 14)
//SIGNAL_SIS3316_CHANNEL_NOGATES(ADC, 3, 2, 16, 15)
#endif
