...
bool FEBEX3_CALIFA_BASE::__match(__data_src_t &__buffer)
{
  ...
  MATCH_BITS_EQUAL(1802,PADDING.all,0xadd);
...
bool GSI_SAM_PADDING::__match(__data_src_t &__buffer)
{
  ...
  MATCH_BITS_EQUAL(1762,padding.unnamed_0_31,0x5a5a5a5a);
  return true;
  return false;
}
...
bool MEGA_PULSER::__match(__data_src_t &__buffer)
{
  // UINT32 mega;
  uint32  __mega;
  READ_FROM_BUFFER(1926,uint32 ,__mega);
  return true;
  return false;
}
...
bool VME_MESYTEC_MQDC32::__match(__data_src_t &__buffer,uint32 geom)
{
  ...
  MATCH_BITS_EQUAL(1667,header.unnamed_12_14,0);
  MATCH_BITS_EQUAL(1668,header.geom,geom);
  MATCH_BITS_EQUAL(1669,header.unnamed_24_29,0);
  MATCH_BITS_EQUAL(1670,header.unnamed_30_31,1);
  MATCH_UNNAMED_BITS_ZERO(1671,header.u32,0x00008000);
  return true;
  return false;
}
...
bool VME_MESYTEC_MTDC32::__match(__data_src_t &__buffer,uint32 geom)
{
  ...
  MATCH_BITS_EQUAL(1624,header.geom,geom);
  MATCH_BITS_EQUAL(1625,header.unnamed_24_29,0);
  MATCH_BITS_EQUAL(1626,header.unnamed_30_31,1);
  MATCH_UNNAMED_BITS_ZERO(1627,header.u32,0x00000c00);
  return true;
  return false;
}
...
bool VME_MESYTEC_VMMR8::__match(__data_src_t &__buffer,uint32 geom)
{
  ...
  MATCH_BITS_EQUAL(1711,header.unnamed_12_15,0);
  MATCH_BITS_EQUAL(1712,header.geom,geom);
  MATCH_BITS_EQUAL(1714,header.unnamed_25_29,0);
  MATCH_BITS_EQUAL(1715,header.unnamed_30_31,1);
  return true;
  return false;
}
...
// fib1a_data()
template<typename __data_src_t>
bool fib1a_data::__match(__data_src_t &__buffer)
{
  // land_vme = LAND_STD_VME();
  CHECK_MATCH_DECL(1982,LAND_STD_VME,land_vme);
  return true;
  return false;
}
FORCE_IMPL_DATA_SRC_FCN(bool,fib1a_data::__match);
...
{
  // land_vme = LAND_STD_VME();
  CHECK_MATCH_DECL(2131,LAND_STD_VME,land_vme);
  return true;
  return false;
}
...
{
  // land_vme = LAND_STD_VME();
  CHECK_MATCH_DECL(1947,LAND_STD_VME,land_vme);
  return true;
  return false;
}
...
{
  // land_vme = LAND_STD_VME();
  CHECK_MATCH_DECL(1965,LAND_STD_VME,land_vme);
  return true;
  return false;
}
...
bool neuland_sfp::__match(__data_src_t &__buffer,uint32 sfp)
{
  ...
  for ( ; ; )
  {
    ...
    int __match_no = 0;
    MATCH_DECL(2006,__match_no,1,TAMEX3_FH_SFP,card[0],/*sfp*/sfp,/*card*/0);
    MATCH_DECL(2007,__match_no,2,TAMEX3_FH_SFP,card[1],/*sfp*/sfp,/*card*/1);
    MATCH_DECL(2008,__match_no,3,TAMEX3_FH_SFP,card[2],/*sfp*/sfp,/*card*/2);
    MATCH_DECL(2009,__match_no,4,TAMEX3_FH_SFP,card[3],/*sfp*/sfp,/*card*/3);
    MATCH_DECL(2010,__match_no,5,TAMEX3_FH_SFP,card[4],/*sfp*/sfp,/*card*/4);
    MATCH_DECL(2011,__match_no,6,TAMEX3_FH_SFP,card[5],/*sfp*/sfp,/*card*/5);
    MATCH_DECL(2012,__match_no,7,TAMEX3_FH_SFP,card[6],/*sfp*/sfp,/*card*/6);
    MATCH_DECL(2013,__match_no,8,TAMEX3_FH_SFP,card[7],/*sfp*/sfp,/*card*/7);
    MATCH_DECL(2014,__match_no,9,TAMEX3_FH_SFP,card[8],/*sfp*/sfp,/*card*/8);
    MATCH_DECL(2015,__match_no,10,TAMEX3_FH_SFP,card[9],/*sfp*/sfp,/*card*/9);
    MATCH_DECL(2016,__match_no,11,TAMEX3_FH_SFP,card[10],/*sfp*/sfp,/*card*/10);
    MATCH_DECL(2017,__match_no,12,TAMEX3_FH_SFP,card[11],/*sfp*/sfp,/*card*/11);
    MATCH_DECL(2018,__match_no,13,TAMEX3_FH_SFP,card[12],/*sfp*/sfp,/*card*/12);
    MATCH_DECL(2019,__match_no,14,TAMEX3_FH_SFP,card[13],/*sfp*/sfp,/*card*/13);
    MATCH_DECL(2020,__match_no,15,TAMEX3_FH_SFP,card[14],/*sfp*/sfp,/*card*/14);
    MATCH_DECL(2021,__match_no,16,TAMEX3_FH_SFP,card[15],/*sfp*/sfp,/*card*/15);
    MATCH_DECL(2022,__match_no,17,TAMEX3_FH_SFP,card[16],/*sfp*/sfp,/*card*/16);
    MATCH_DECL(2023,__match_no,18,TAMEX3_FH_SFP,card[17],/*sfp*/sfp,/*card*/17);
    MATCH_DECL(2024,__match_no,19,TAMEX3_FH_SFP,card[18],/*sfp*/sfp,/*card*/18);
    MATCH_DECL(2025,__match_no,20,TAMEX3_FH_SFP,card[19],/*sfp*/sfp,/*card*/19);
    MATCH_DECL(2026,__match_no,21,TAMEX3_FH_SFP,card[20],/*sfp*/sfp,/*card*/20);
    MATCH_DECL(2027,__match_no,22,TAMEX3_FH_SFP,card[21],/*sfp*/sfp,/*card*/21);
    MATCH_DECL(2028,__match_no,23,TAMEX3_FH_SFP,card[22],/*sfp*/sfp,/*card*/22);
    MATCH_DECL(2029,__match_no,24,TAMEX3_FH_SFP,card[23],/*sfp*/sfp,/*card*/23);
    MATCH_DECL(2030,__match_no,25,TAMEX3_FH_SFP,card[24],/*sfp*/sfp,/*card*/24);
    MATCH_DECL(2031,__match_no,26,TAMEX3_FH_SFP,card[25],/*sfp*/sfp,/*card*/25);
    MATCH_DECL(2032,__match_no,27,TAMEX3_FH_SFP,card[26],/*sfp*/sfp,/*card*/26);
    MATCH_DECL(2033,__match_no,28,TAMEX3_FH_SFP,card[27],/*sfp*/sfp,/*card*/27);
    MATCH_DECL(2034,__match_no,29,TAMEX3_FH_SFP,card[28],/*sfp*/sfp,/*card*/28);
    MATCH_DECL(2035,__match_no,30,TAMEX3_FH_SFP,card[29],/*sfp*/sfp,/*card*/29);
    MATCH_DECL(2036,__match_no,31,TAMEX3_FH_SFP,card[30],/*sfp*/sfp,/*card*/30);
    MATCH_DECL(2037,__match_no,32,TAMEX3_FH_SFP,card[31],/*sfp*/sfp,/*card*/31);
    MATCH_DECL(2038,__match_no,33,TAMEX3_FH_SFP,card[32],/*sfp*/sfp,/*card*/32);
    MATCH_DECL(2039,__match_no,34,TAMEX3_FH_SFP,card[33],/*sfp*/sfp,/*card*/33);
    MATCH_DECL(2040,__match_no,35,TAMEX3_FH_SFP,card[34],/*sfp*/sfp,/*card*/34);
    if (!__match_no) break;
    return true;
  }
  return false;
...
{
  // land_vme = LAND_STD_VME();
  CHECK_MATCH_DECL(2046,LAND_STD_VME,land_vme);
  return true;
  return false;
}
...
{
  // land_vme = LAND_STD_VME();
  CHECK_MATCH_DECL(2154,LAND_STD_VME,land_vme);
  return true;
  return false;
}
...
{
  // land_vme = LAND_STD_VME();
  CHECK_MATCH_DECL(2182,LAND_STD_VME,land_vme);
  return true;
  return false;
}
...
{
  // land_vme = LAND_STD_VME();
  CHECK_MATCH_DECL(2087,LAND_STD_VME,land_vme);
  return true;
  return false;
}
...
{
  // land_vme = LAND_STD_VME();
  CHECK_MATCH_DECL(2071,LAND_STD_VME,land_vme);
  return true;
  return false;
}
...
{
  // land_vme = LAND_STD_VME();
  CHECK_MATCH_DECL(2116,LAND_STD_VME,land_vme);
  return true;
  return false;
}
...
{
  // land_vme = LAND_STD_VME();
  CHECK_MATCH_DECL(2102,LAND_STD_VME,land_vme);
  return true;
  return false;
}
...
/** BEGIN_MATCHER ******************************************************
 *
 * Event matcher for ams_siderem1_subev.
 *
 * Do not edit - automatically generated.
 */
...
/** BEGIN_MATCHER ******************************************************
 *
 * Event matcher for ams_siderem2_subev.
 *
 * Do not edit - automatically generated.
 */
...
/** BEGIN_MATCHER ******************************************************
 *
 * Event matcher for fib1ab_subev.
 *
 * Do not edit - automatically generated.
 */
