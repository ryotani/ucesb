...
STRUCT_MIRROR_TEMPLATE
class STRUCT_MIRROR_STRUCT(raw_event_PTOF_P_T)
{
public:
  STRUCT_MIRROR_ITEM_CTRL(TFL);
  STRUCT_MIRROR_TYPE(raw_array_multi_zero_suppress) < STRUCT_MIRROR_TYPE_TEMPLATE STRUCT_MIRROR_TEMPLATE_ARG(DATA12),STRUCT_MIRROR_TEMPLATE_ARG(DATA12),6,32> STRUCT_MIRROR_NAME(TFL);
  ...
  STRUCT_MIRROR_ITEM_CTRL(TCT);
  STRUCT_MIRROR_TYPE(raw_array_multi_zero_suppress) < STRUCT_MIRROR_TYPE_TEMPLATE STRUCT_MIRROR_TEMPLATE_ARG(DATA16),STRUCT_MIRROR_TEMPLATE_ARG(DATA16),6,32> STRUCT_MIRROR_NAME(TCT);
  STRUCT_MIRROR_FCNS_DECL(raw_event_PTOF_P_T);
};
#endif//USER_DEF_raw_event_PTOF_P_T

#ifndef USER_DEF_raw_event_PTOF_P
STRUCT_MIRROR_TEMPLATE
class STRUCT_MIRROR_STRUCT(raw_event_PTOF_P)
{
public:
  STRUCT_MIRROR_ITEM_CTRL(T);
  STRUCT_MIRROR_ITEM_CTRL_ARRAY(T__i0,,2);
  STRUCT_MIRROR_TYPE(raw_event_PTOF_P_T) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(T[2]);
  STRUCT_MIRROR_FCNS_DECL(raw_event_PTOF_P);
};
#endif//USER_DEF_raw_event_PTOF_P

#ifndef USER_DEF_raw_event_PTOF
STRUCT_MIRROR_TEMPLATE
class STRUCT_MIRROR_STRUCT(raw_event_PTOF)
{
public:
  STRUCT_MIRROR_ITEM_CTRL(P);
  STRUCT_MIRROR_ITEM_CTRL_ARRAY(P__i0,,2);
  STRUCT_MIRROR_TYPE(raw_event_PTOF_P) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(P[2]);
  STRUCT_MIRROR_FCNS_DECL(raw_event_PTOF);
};
...
public:
  ...
  STRUCT_MIRROR_ITEM_CTRL(PTOF);
  STRUCT_MIRROR_TYPE(raw_event_PTOF) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(PTOF);
