...
public:
  ...
  STRUCT_MIRROR_ITEM_CTRL(straw_ts);
  STRUCT_MIRROR_TYPE(wr_400) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(straw_ts);
  STRUCT_MIRROR_ITEM_CTRL(straw);
  STRUCT_MIRROR_TYPE(straw_vme_subev) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(straw);
