...
class raw_event_FIFILTER
{
  raw_array_zero_suppress<DATA32,DATA32,200> E;
  STRUCT_FCNS_DECL(raw_event_FIFILTER);
} ;
class raw_event_FITRACE
{
  raw_array_zero_suppress<DATA16,DATA16,200> E;
  STRUCT_FCNS_DECL(raw_event_FITRACE);
} ;
...
class raw_event : public raw_event_base
{
  ...
  raw_event_TOFD
       TOFD;
  raw_array_multi_zero_suppress<DATA32,DATA32,65,20> PSPX[5];
  raw_event_PSPXT
       PSPXT[5][65];
  raw_event_TIMESTAMP
       TIMESTAMP;
