...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(raw_event_FIFILTER)::FCNCALL_NAME(raw_event_FIFILTER)
{
  FCNCALL_INIT;
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(raw_event_FITRACE)::FCNCALL_NAME(raw_event_FITRACE)
{
  FCNCALL_INIT;
...
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(raw_event)::FCNCALL_NAME(raw_event)
{
  ...
  // raw_event_FIFILTER FIFILTER[10][16];
  {
  FCNCALL_SUBNAME("FIFILTER");
  FCNCALL_FOR(__i0,10)
  {
    FCNCALL_SUBINDEX(__i0);
    FCNCALL_FOR(__i1,16)
    {
      FCNCALL_SUBINDEX(__i1);
      { FCNCALL_CALL_CTRL_WRAP_ARRAY(FIFILTER__i0__i1,[__i0],__i1,FIFILTER[__i0][__i1].FCNCALL_CALL(FIFILTER[__i0][__i1])); }
      FCNCALL_SUBINDEX_END(__i1);
    }
    FCNCALL_SUBINDEX_END(__i0);
  }
  ...
  // raw_event_FITRACE FITRACE[10][16];
  {
  FCNCALL_SUBNAME("FITRACE");
  FCNCALL_FOR(__i0,10)
  {
    FCNCALL_SUBINDEX(__i0);
    FCNCALL_FOR(__i1,16)
    {
      FCNCALL_SUBINDEX(__i1);
      { FCNCALL_CALL_CTRL_WRAP_ARRAY(FITRACE__i0__i1,[__i0],__i1,FITRACE[__i0][__i1].FCNCALL_CALL(FITRACE[__i0][__i1])); }
      FCNCALL_SUBINDEX_END(__i1);
    }
    FCNCALL_SUBINDEX_END(__i0);
  }
