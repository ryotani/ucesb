  ...
  // tofd_empty = empty_subev(type=10,subtype=1,control=2);
{
  ...
  switch (__match_no)
  {
    ...
    case 15:
      ...
      REVOKE_SUBEVENT_DECL(959,0,wr_400,straw_ts);
      break;
    case 16:
      UNPACK_SUBEVENT_CHECK_NO_REVISIT(960,straw_vme_subev,straw,15);
      REVOKE_SUBEVENT_DECL(960,0,straw_vme_subev,straw);
      break;
    case 17:
      UNPACK_SUBEVENT_CHECK_NO_REVISIT(962,empty_subev,los_empty,16);
      REVOKE_SUBEVENT_DECL(962,0,empty_subev,los_empty);
      break;
    case 18:
      UNPACK_SUBEVENT_CHECK_NO_REVISIT(963,empty_subev,tofd_empty,17);
      REVOKE_SUBEVENT_DECL(963,0,empty_subev,tofd_empty);
      break;
  }
  return 0;
}
