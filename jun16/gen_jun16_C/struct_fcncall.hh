...
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(tracking_febex_subev)::FCNCALL_NAME(tracking_febex_subev)
{
  ...
  // FEBEX_TRACE febextrace_0[18];
  {
  FCNCALL_SUBNAME("febextrace_0");
  FCNCALL_FOR(__i0,18)
  {
    FCNCALL_SUBINDEX(__i0);
    { FCNCALL_CALL_CTRL_WRAP_ARRAY(febextrace_0__i0,,__i0,febextrace_0[__i0].FCNCALL_CALL(febextrace_0[__i0])); }
    FCNCALL_SUBINDEX_END(__i0);
  }
  FCNCALL_SUBNAME_END;
  }
...
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(unpack_event)::FCNCALL_NAME(unpack_event)
{
  ...
  // fitest_febex_subev fitest_febex;
  {
  FCNCALL_SUBNAME("fitest_febex");
  { FCNCALL_CALL_CTRL_WRAP(fitest_febex,fitest_febex.FCNCALL_CALL(fitest_febex)); }
  FCNCALL_SUBNAME_END;
  }
  // wr_400 straw_ts;
  {
  FCNCALL_SUBNAME("straw_ts");
  { FCNCALL_CALL_CTRL_WRAP(straw_ts,straw_ts.FCNCALL_CALL(straw_ts)); }
  FCNCALL_SUBNAME_END;
  }
  // straw_vme_subev straw;
  {
  FCNCALL_SUBNAME("straw");
  { FCNCALL_CALL_CTRL_WRAP(straw,straw.FCNCALL_CALL(straw)); }
  FCNCALL_SUBNAME_END;
  }
