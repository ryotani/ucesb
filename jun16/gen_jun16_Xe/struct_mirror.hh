...
#ifndef USER_DEF_FEBEX_BADBAD
STRUCT_MIRROR_TEMPLATE
class STRUCT_MIRROR_STRUCT(FEBEX_BADBAD)
{
public:
#if STRUCT_ONLY_LAST_UNION_MEMBER
  struct 
  ...
  STRUCT_MIRROR_FCNS_DECL(FEBEX_BADBAD);
};
#endif//USER_DEF_FEBEX_BADBAD
...
public:
  STRUCT_MIRROR_ITEM_CTRL_BASE(unpack_subevent_base);
  STRUCT_MIRROR_ITEM_CTRL(vftx2);
  STRUCT_MIRROR_TYPE(VME_GSI_VFTX2_LT) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(vftx2);
...
public:
  STRUCT_MIRROR_ITEM_CTRL_BASE(unpack_subevent_base);
  STRUCT_MIRROR_ITEM_CTRL(badbad0);
  STRUCT_MIRROR_TYPE(FEBEX_BADBAD) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(badbad0);
  STRUCT_MIRROR_ITEM_CTRL(febex_0);
  STRUCT_MIRROR_ITEM_CTRL_ARRAY(febex_0__i0,,18);
  STRUCT_MIRROR_TYPE(FEBEX_NOTRACE) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(febex_0[18]);
  ...
  STRUCT_MIRROR_ITEM_CTRL(febextrace_0);
  STRUCT_MIRROR_ITEM_CTRL_ARRAY(febextrace_0__i0,,18);
  STRUCT_MIRROR_TYPE(FEBEX_TRACE) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(febextrace_0[18]);
  STRUCT_MIRROR_ITEM_CTRL(badbad1);
  STRUCT_MIRROR_TYPE(FEBEX_BADBAD) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(badbad1);
  STRUCT_MIRROR_ITEM_CTRL(febex_1);
  STRUCT_MIRROR_ITEM_CTRL_ARRAY(febex_1__i0,,16);
  STRUCT_MIRROR_TYPE(FEBEX_NOTRACE) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(febex_1[16]);
  STRUCT_MIRROR_ITEM_CTRL(header1);
  STRUCT_MIRROR_TYPE(FEBEX_EVENTHEADER) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(header1);
  STRUCT_MIRROR_ITEM_CTRL(febextrace_1);
  STRUCT_MIRROR_ITEM_CTRL_ARRAY(febextrace_1__i0,,16);
  STRUCT_MIRROR_TYPE(FEBEX_TRACE) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(febextrace_1[16]);
...
public:
  ...
  STRUCT_MIRROR_ITEM_CTRL(fitest_febex);
  STRUCT_MIRROR_TYPE(fitest_febex_subev) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(fitest_febex);
