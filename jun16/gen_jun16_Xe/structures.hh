...
/** BEGIN_STRUCTURES ***************************************************
 *
 * Event unpacker associated structures for FEBEX_BADBAD.
 *
 * Do not edit - automatically generated.
 */
...
// FEBEX_BADBAD()
#if !PACKER_CODE
# define DECLARED_UNPACK_FEBEX_BADBAD
class FEBEX_BADBAD
#else//PACKER_CODE
# define DECLARED_PACKER_FEBEX_BADBAD
class PACKER_FEBEX_BADBAD
#endif//PACKER_CODE
...
public:
  ...
  SINGLE(FEBEX_BADBAD,badbad1);
  SINGLE(FEBEX_NOTRACE,febex_1[16]);
  SINGLE(FEBEX_EVENTHEADER,header1);
  SINGLE(FEBEX_TRACE,febextrace_1[16]);
