...
// FEBEX_BADBAD()
template<typename __data_dest_t>
void PACKER_FEBEX_BADBAD::__packer(__data_dest_t &__buffer)
{
  // UINT32 badbad
  // {
    //  0_31: 0xbad00bad;
...
FORCE_IMPL_DATA_SRC_FCN(void,FEBEX_BADBAD::__packer);
...
void PACKER_fitest_febex_subev::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(871,FEBEX_EVENTHEADER,header);
  // select several

    // padding = FEBEX_PADDING();
  {
    PACK_DECL(873,FEBEX_PADDING,padding);
  }
  // select several
  ...
  {
    PACK_DECL(876,FEBEX_NOTRACE,febex[0],/*sfp*/3,/*card*/0);
    PACK_DECL(877,FEBEX_NOTRACE,febex[1],/*sfp*/3,/*card*/1);
    PACK_DECL(878,FEBEX_NOTRACE,febex[2],/*sfp*/3,/*card*/2);
    PACK_DECL(879,FEBEX_NOTRACE,febex[3],/*sfp*/3,/*card*/3);
    PACK_DECL(880,FEBEX_NOTRACE,febex[4],/*sfp*/3,/*card*/4);
    PACK_DECL(881,FEBEX_NOTRACE,febex[5],/*sfp*/3,/*card*/5);
    PACK_DECL(882,FEBEX_NOTRACE,febex[6],/*sfp*/3,/*card*/6);
    PACK_DECL(883,FEBEX_NOTRACE,febex[7],/*sfp*/3,/*card*/7);
    PACK_DECL(884,FEBEX_TRACE,febextrace[0],/*sfp*/3,/*card*/0);
    PACK_DECL(885,FEBEX_TRACE,febextrace[1],/*sfp*/3,/*card*/1);
    PACK_DECL(886,FEBEX_TRACE,febextrace[2],/*sfp*/3,/*card*/2);
    PACK_DECL(887,FEBEX_TRACE,febextrace[3],/*sfp*/3,/*card*/3);
    PACK_DECL(888,FEBEX_TRACE,febextrace[4],/*sfp*/3,/*card*/4);
    PACK_DECL(889,FEBEX_TRACE,febextrace[5],/*sfp*/3,/*card*/5);
    PACK_DECL(890,FEBEX_TRACE,febextrace[6],/*sfp*/3,/*card*/6);
    PACK_DECL(891,FEBEX_TRACE,febextrace[7],/*sfp*/3,/*card*/7);
  }
}
...
void PACKER_lmu_scalers_subev::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(753,TRLOII_LMU_SCALERS,scalers,/*id*/199);
}
...
void PACKER_los_sampler_subev::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(775,LAND_STD_VME,land_vme);
  // select several

    // sampler = TRLOII_SAMPLER(mark=0x1050);
  {
    PACK_DECL(777,TRLOII_SAMPLER,sampler,/*mark*/0x1050);
  }
}
...
{
  // land_vme = LAND_STD_VME();
  PACK_DECL(758,LAND_STD_VME,land_vme);
  // barrier1 = BARRIER();
  PACK_DECL(759,BARRIER,barrier1);
  // barrier2 = BARRIER();
  PACK_DECL(760,BARRIER,barrier2);
  // select several

    // vftx2 = VME_GSI_VFTX2_7PS(id=2);
  {
    PACK_DECL(762,VME_GSI_VFTX2_7PS,vftx2,/*id*/2);
  }
}
...
void PACKER_straw_vme_subev::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(898,VME_GSI_VFTX2_STRAW,vftx2,/*id*/0);
  }
}
...
{
  // land_vme = LAND_STD_VME();
  PACK_DECL(904,LAND_STD_VME,land_vme);
  // barrier = BARRIER();
  PACK_DECL(906,BARRIER,barrier);
  // select several

    // vftx2 = VME_GSI_VFTX2_LT(id=1);
    // madc32 = VME_MESYTEC_MADC32(geom=2);
  {
    PACK_DECL(908,VME_GSI_VFTX2_LT,vftx2,/*id*/1);
    PACK_DECL(909,VME_MESYTEC_MADC32,madc32,/*geom*/2);
  }
}
...
void PACKER_tofd_tamex_subev::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(916,TAMEX3_HEADER,header);
  // select several

    // padding1 = TAMEX3_PADDING();
  {
    PACK_DECL(918,TAMEX3_PADDING,padding1);
  }
  // select several
  ...
  {
    PACK_DECL(921,TAMEX3_SFP,tamex_1,/*sfp*/2,/*card*/0);
    PACK_DECL(922,TAMEX3_SFP,tamex_2,/*sfp*/2,/*card*/1);
  }
  // select several

    // padding2 = TAMEX3_PADDING();
  {
    PACK_DECL(925,TAMEX3_PADDING,padding2);
  }
  // select several
  ...
  {
    PACK_DECL(928,TAMEX3_SFP,tamex_3,/*sfp*/3,/*card*/0);
    PACK_DECL(929,TAMEX3_SFP,tamex_4,/*sfp*/3,/*card*/1);
  }
}
...
{
  // land_vme = LAND_STD_VME();
  PACK_DECL(935,LAND_STD_VME,land_vme);
  // barrier = BARRIER();
  PACK_DECL(936,BARRIER,barrier);
  // select several
  ...
  {
    PACK_DECL(938,VME_GSI_VFTX2_7PS,vftx2_1,/*id*/1);
    PACK_DECL(939,VME_GSI_VFTX2_7PS,vftx2_2,/*id*/2);
    PACK_DECL(940,VME_GSI_VFTX2_7PS,vftx2_3,/*id*/3);
  }
}
...
void PACKER_tpat_subev::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(946,TRLOII_TPAT,tpat,/*id*/207);
}
...
void PACKER_tracking_febex_subev::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(791,FEBEX_BADBAD,badbad0);
    PACK_DECL(792,FEBEX_EVENTHEADER,header0);
    PACK_DECL(793,FEBEX_NOTRACE,febex_0[0],/*sfp*/0,/*card*/0);
    PACK_DECL(794,FEBEX_NOTRACE,febex_0[1],/*sfp*/0,/*card*/1);
    PACK_DECL(795,FEBEX_NOTRACE,febex_0[2],/*sfp*/0,/*card*/2);
    PACK_DECL(796,FEBEX_NOTRACE,febex_0[3],/*sfp*/0,/*card*/3);
    PACK_DECL(797,FEBEX_NOTRACE,febex_0[4],/*sfp*/0,/*card*/4);
    PACK_DECL(798,FEBEX_NOTRACE,febex_0[5],/*sfp*/0,/*card*/5);
    PACK_DECL(799,FEBEX_NOTRACE,febex_0[6],/*sfp*/0,/*card*/6);
    PACK_DECL(800,FEBEX_NOTRACE,febex_0[7],/*sfp*/0,/*card*/7);
    PACK_DECL(801,FEBEX_NOTRACE,febex_0[8],/*sfp*/0,/*card*/8);
    PACK_DECL(802,FEBEX_NOTRACE,febex_0[9],/*sfp*/0,/*card*/9);
    PACK_DECL(803,FEBEX_NOTRACE,febex_0[10],/*sfp*/0,/*card*/10);
    PACK_DECL(804,FEBEX_NOTRACE,febex_0[11],/*sfp*/0,/*card*/11);
    PACK_DECL(805,FEBEX_NOTRACE,febex_0[12],/*sfp*/0,/*card*/12);
    PACK_DECL(806,FEBEX_NOTRACE,febex_0[13],/*sfp*/0,/*card*/13);
    PACK_DECL(807,FEBEX_NOTRACE,febex_0[14],/*sfp*/0,/*card*/14);
    PACK_DECL(808,FEBEX_NOTRACE,febex_0[15],/*sfp*/0,/*card*/15);
    PACK_DECL(809,FEBEX_NOTRACE,febex_0[16],/*sfp*/0,/*card*/16);
    PACK_DECL(810,FEBEX_NOTRACE,febex_0[17],/*sfp*/0,/*card*/17);
    PACK_DECL(811,FEBEX_TRACE,febextrace_0[0],/*sfp*/0,/*card*/0);
    PACK_DECL(812,FEBEX_TRACE,febextrace_0[1],/*sfp*/0,/*card*/1);
    PACK_DECL(813,FEBEX_TRACE,febextrace_0[2],/*sfp*/0,/*card*/2);
    PACK_DECL(814,FEBEX_TRACE,febextrace_0[3],/*sfp*/0,/*card*/3);
    PACK_DECL(815,FEBEX_TRACE,febextrace_0[4],/*sfp*/0,/*card*/4);
    PACK_DECL(816,FEBEX_TRACE,febextrace_0[5],/*sfp*/0,/*card*/5);
    PACK_DECL(817,FEBEX_TRACE,febextrace_0[6],/*sfp*/0,/*card*/6);
    PACK_DECL(818,FEBEX_TRACE,febextrace_0[7],/*sfp*/0,/*card*/7);
    PACK_DECL(819,FEBEX_TRACE,febextrace_0[8],/*sfp*/0,/*card*/8);
    PACK_DECL(820,FEBEX_TRACE,febextrace_0[9],/*sfp*/0,/*card*/9);
    PACK_DECL(821,FEBEX_TRACE,febextrace_0[10],/*sfp*/0,/*card*/10);
    PACK_DECL(822,FEBEX_TRACE,febextrace_0[11],/*sfp*/0,/*card*/11);
    PACK_DECL(823,FEBEX_TRACE,febextrace_0[12],/*sfp*/0,/*card*/12);
    PACK_DECL(824,FEBEX_TRACE,febextrace_0[13],/*sfp*/0,/*card*/13);
    PACK_DECL(825,FEBEX_TRACE,febextrace_0[14],/*sfp*/0,/*card*/14);
    PACK_DECL(826,FEBEX_TRACE,febextrace_0[15],/*sfp*/0,/*card*/15);
    PACK_DECL(827,FEBEX_TRACE,febextrace_0[16],/*sfp*/0,/*card*/16);
    PACK_DECL(828,FEBEX_TRACE,febextrace_0[17],/*sfp*/0,/*card*/17);
  }
  // select several
  ...
  {
    PACK_DECL(831,FEBEX_BADBAD,badbad1);
    PACK_DECL(832,FEBEX_EVENTHEADER,header1);
    PACK_DECL(833,FEBEX_NOTRACE,febex_1[0],/*sfp*/2,/*card*/0);
    PACK_DECL(834,FEBEX_NOTRACE,febex_1[1],/*sfp*/2,/*card*/1);
    PACK_DECL(835,FEBEX_NOTRACE,febex_1[2],/*sfp*/2,/*card*/2);
    PACK_DECL(836,FEBEX_NOTRACE,febex_1[3],/*sfp*/2,/*card*/3);
    PACK_DECL(837,FEBEX_NOTRACE,febex_1[4],/*sfp*/2,/*card*/4);
    PACK_DECL(838,FEBEX_NOTRACE,febex_1[5],/*sfp*/2,/*card*/5);
    PACK_DECL(839,FEBEX_NOTRACE,febex_1[6],/*sfp*/2,/*card*/6);
    PACK_DECL(840,FEBEX_NOTRACE,febex_1[7],/*sfp*/2,/*card*/7);
    PACK_DECL(841,FEBEX_NOTRACE,febex_1[8],/*sfp*/2,/*card*/8);
    PACK_DECL(842,FEBEX_NOTRACE,febex_1[9],/*sfp*/2,/*card*/9);
    PACK_DECL(843,FEBEX_NOTRACE,febex_1[10],/*sfp*/2,/*card*/10);
    PACK_DECL(844,FEBEX_NOTRACE,febex_1[11],/*sfp*/2,/*card*/11);
    PACK_DECL(845,FEBEX_NOTRACE,febex_1[12],/*sfp*/2,/*card*/12);
    PACK_DECL(846,FEBEX_NOTRACE,febex_1[13],/*sfp*/2,/*card*/13);
    PACK_DECL(847,FEBEX_NOTRACE,febex_1[14],/*sfp*/2,/*card*/14);
    PACK_DECL(848,FEBEX_NOTRACE,febex_1[15],/*sfp*/2,/*card*/15);
    PACK_DECL(849,FEBEX_TRACE,febextrace_1[0],/*sfp*/2,/*card*/0);
    PACK_DECL(850,FEBEX_TRACE,febextrace_1[1],/*sfp*/2,/*card*/1);
    PACK_DECL(851,FEBEX_TRACE,febextrace_1[2],/*sfp*/2,/*card*/2);
    PACK_DECL(852,FEBEX_TRACE,febextrace_1[3],/*sfp*/2,/*card*/3);
    PACK_DECL(853,FEBEX_TRACE,febextrace_1[4],/*sfp*/2,/*card*/4);
    PACK_DECL(854,FEBEX_TRACE,febextrace_1[5],/*sfp*/2,/*card*/5);
    PACK_DECL(855,FEBEX_TRACE,febextrace_1[6],/*sfp*/2,/*card*/6);
    PACK_DECL(856,FEBEX_TRACE,febextrace_1[7],/*sfp*/2,/*card*/7);
    PACK_DECL(857,FEBEX_TRACE,febextrace_1[8],/*sfp*/2,/*card*/8);
    PACK_DECL(858,FEBEX_TRACE,febextrace_1[9],/*sfp*/2,/*card*/9);
    PACK_DECL(859,FEBEX_TRACE,febextrace_1[10],/*sfp*/2,/*card*/10);
    PACK_DECL(860,FEBEX_TRACE,febextrace_1[11],/*sfp*/2,/*card*/11);
    PACK_DECL(861,FEBEX_TRACE,febextrace_1[12],/*sfp*/2,/*card*/12);
    PACK_DECL(862,FEBEX_TRACE,febextrace_1[13],/*sfp*/2,/*card*/13);
    PACK_DECL(863,FEBEX_TRACE,febextrace_1[14],/*sfp*/2,/*card*/14);
    PACK_DECL(864,FEBEX_TRACE,febextrace_1[15],/*sfp*/2,/*card*/15);
  }
}
...
void PACKER_wr_100::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(726,TIMESTAMP_WHITERABBIT,ts100,/*id*/0x100);
  // multi_ = WR_MULTI();
  PACK_DECL(729,WR_MULTI,multi_);
}
...
void PACKER_wr_200::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(735,TIMESTAMP_WHITERABBIT,ts200,/*id*/0x200);
  // multi_ = WR_MULTI();
  PACK_DECL(738,WR_MULTI,multi_);
}
...
void PACKER_wr_400::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(744,TIMESTAMP_WHITERABBIT,ts400,/*id*/0x400);
}
