...
void fitest_febex_subev::__unpack(__data_src_t &__buffer)
{
  ...
  UNPACK_DECL(858,FEBEX_EVENTHEADER,header);
  // select several
  ...
  for ( ; ; )
  {
    ...
    {
    uint32 __match_peek;
    PEEK_FROM_BUFFER(861,uint32,__match_peek);
    // differ = 00000000 :
    ...
    {
      case 1:
        CHECK_SPURIOUS_MATCH_DECL(860,spurious_match_abort_loop_1,FEBEX_PADDING);
        UNPACK_DECL(860,FEBEX_PADDING,padding);
        break;
    }
  }
  ...
  for ( ; ; )
  {
    ...
    {
    uint32 __match_peek;
    PEEK_FROM_BUFFER(879,uint32,__match_peek);
    ...
    if (__match_peek & 0x00040000) {
      ...
      if (__match_peek & 0x00020000) {
        ...
        if (__match_peek & 0x00010000) {
          ...
          VERIFY_MATCH_DECL_QUICK(870,__match_no,8,febex[7],__match_peek,0xfffff0ff,0xff073034,FEBEX_NOTRACE,/*sfp*/3,/*card*/7);
          VERIFY_MATCH_DECL_QUICK(878,__match_no,16,febextrace[7],__match_peek,0x00fff0ff,0x00073034,FEBEX_TRACE,/*sfp*/3,/*card*/7);
        } else {
          // Indistinguishable: 0 1
          VERIFY_MATCH_DECL_QUICK(869,__match_no,7,febex[6],__match_peek,0xfffff0ff,0xff063034,FEBEX_NOTRACE,/*sfp*/3,/*card*/6);
          VERIFY_MATCH_DECL_QUICK(877,__match_no,15,febextrace[6],__match_peek,0x00fff0ff,0x00063034,FEBEX_TRACE,/*sfp*/3,/*card*/6);
        }
      } else {
        // select on bit 16, partition: 1:2(d2) 0:2(d2)
        if (__match_peek & 0x00010000) {
          // Indistinguishable: 0 1
          VERIFY_MATCH_DECL_QUICK(868,__match_no,6,febex[5],__match_peek,0xfffff0ff,0xff053034,FEBEX_NOTRACE,/*sfp*/3,/*card*/5);
          VERIFY_MATCH_DECL_QUICK(876,__match_no,14,febextrace[5],__match_peek,0x00fff0ff,0x00053034,FEBEX_TRACE,/*sfp*/3,/*card*/5);
        } else {
          // Indistinguishable: 0 1
          VERIFY_MATCH_DECL_QUICK(867,__match_no,5,febex[4],__match_peek,0xfffff0ff,0xff043034,FEBEX_NOTRACE,/*sfp*/3,/*card*/4);
          VERIFY_MATCH_DECL_QUICK(875,__match_no,13,febextrace[4],__match_peek,0x00fff0ff,0x00043034,FEBEX_TRACE,/*sfp*/3,/*card*/4);
        }
      }
    } else {
      // select on bit 17, partition: 1:4(d4) 0:4(d4)
      if (__match_peek & 0x00020000) {
        ...
        if (__match_peek & 0x00010000) {
          // Indistinguishable: 0 1
          VERIFY_MATCH_DECL_QUICK(866,__match_no,4,febex[3],__match_peek,0xfffff0ff,0xff033034,FEBEX_NOTRACE,/*sfp*/3,/*card*/3);
          VERIFY_MATCH_DECL_QUICK(874,__match_no,12,febextrace[3],__match_peek,0x00fff0ff,0x00033034,FEBEX_TRACE,/*sfp*/3,/*card*/3);
        } else {
          // Indistinguishable: 0 1
          VERIFY_MATCH_DECL_QUICK(865,__match_no,3,febex[2],__match_peek,0xfffff0ff,0xff023034,FEBEX_NOTRACE,/*sfp*/3,/*card*/2);
          VERIFY_MATCH_DECL_QUICK(873,__match_no,11,febextrace[2],__match_peek,0x00fff0ff,0x00023034,FEBEX_TRACE,/*sfp*/3,/*card*/2);
        }
      } else {
        // select on bit 16, partition: 1:2(d2) 0:2(d2)
        if (__match_peek & 0x00010000) {
          // Indistinguishable: 0 1
          VERIFY_MATCH_DECL_QUICK(864,__match_no,2,febex[1],__match_peek,0xfffff0ff,0xff013034,FEBEX_NOTRACE,/*sfp*/3,/*card*/1);
          VERIFY_MATCH_DECL_QUICK(872,__match_no,10,febextrace[1],__match_peek,0x00fff0ff,0x00013034,FEBEX_TRACE,/*sfp*/3,/*card*/1);
        } else {
          // Indistinguishable: 0 1
          VERIFY_MATCH_DECL_QUICK(863,__match_no,1,febex[0],__match_peek,0xfffff0ff,0xff003034,FEBEX_NOTRACE,/*sfp*/3,/*card*/0);
          VERIFY_MATCH_DECL_QUICK(871,__match_no,9,febextrace[0],__match_peek,0x00fff0ff,0x00003034,FEBEX_TRACE,/*sfp*/3,/*card*/0);
        }
      }
    }
    ...
    {
      case 1:
        UNPACK_DECL(863,FEBEX_NOTRACE,febex[0],/*sfp*/3,/*card*/0);
        break;
      case 2:
        UNPACK_DECL(864,FEBEX_NOTRACE,febex[1],/*sfp*/3,/*card*/1);
        break;
      case 3:
        UNPACK_DECL(865,FEBEX_NOTRACE,febex[2],/*sfp*/3,/*card*/2);
        break;
      case 4:
        UNPACK_DECL(866,FEBEX_NOTRACE,febex[3],/*sfp*/3,/*card*/3);
        break;
      case 5:
        UNPACK_DECL(867,FEBEX_NOTRACE,febex[4],/*sfp*/3,/*card*/4);
        break;
      case 6:
        UNPACK_DECL(868,FEBEX_NOTRACE,febex[5],/*sfp*/3,/*card*/5);
        break;
      case 7:
        UNPACK_DECL(869,FEBEX_NOTRACE,febex[6],/*sfp*/3,/*card*/6);
        break;
      case 8:
        UNPACK_DECL(870,FEBEX_NOTRACE,febex[7],/*sfp*/3,/*card*/7);
        break;
      case 9:
        UNPACK_DECL(871,FEBEX_TRACE,febextrace[0],/*sfp*/3,/*card*/0);
        break;
      case 10:
        UNPACK_DECL(872,FEBEX_TRACE,febextrace[1],/*sfp*/3,/*card*/1);
        break;
      case 11:
        UNPACK_DECL(873,FEBEX_TRACE,febextrace[2],/*sfp*/3,/*card*/2);
        break;
      case 12:
        UNPACK_DECL(874,FEBEX_TRACE,febextrace[3],/*sfp*/3,/*card*/3);
        break;
      case 13:
        UNPACK_DECL(875,FEBEX_TRACE,febextrace[4],/*sfp*/3,/*card*/4);
        break;
      case 14:
        UNPACK_DECL(876,FEBEX_TRACE,febextrace[5],/*sfp*/3,/*card*/5);
        break;
      case 15:
        UNPACK_DECL(877,FEBEX_TRACE,febextrace[6],/*sfp*/3,/*card*/6);
        break;
      case 16:
        UNPACK_DECL(878,FEBEX_TRACE,febextrace[7],/*sfp*/3,/*card*/7);
        break;
    }
  }
}
...
void straw_vme_subev::__unpack(__data_src_t &__buffer)
{
  ...
  for ( ; ; )
  {
    ...
    {
    uint32 __match_peek;
    PEEK_FROM_BUFFER(886,uint32,__match_peek);
    // differ = 00000000 :
    uint32 __match_index = 0;
    static const sint8 __match_index_array[1] = { 1, };
    __match_no = __match_index_array[__match_index];
    ...
    {
      case 1:
        UNPACK_DECL(885,VME_GSI_VFTX2_STRAW,vftx2,/*id*/0);
        break;
    }
  }
}
...
{
  // land_vme = LAND_STD_VME();
  UNPACK_DECL(891,LAND_STD_VME,land_vme);
  // barrier = BARRIER();
  UNPACK_DECL(893,BARRIER,barrier);
  // select several
  ...
  for ( ; ; )
  {
    ...
    MATCH_DECL_QUICK(895,__match_no,1,vftx2,__match_peek,0xfffc001f,0xab000001);
    MATCH_DECL_QUICK(896,__match_no,2,madc32,__match_peek,0xffff0000,0x40020000);
    // last_subevent_item = 1
    }
    if (!__match_no) break;
    switch (__match_no)
    {
      case 1:
        UNPACK_DECL(895,VME_GSI_VFTX2_LT,vftx2,/*id*/1);
        break;
      case 2:
        UNPACK_DECL(896,VME_MESYTEC_MADC32,madc32,/*geom*/2);
        break;
    }
  }
}
...
void tofd_tamex_subev::__unpack(__data_src_t &__buffer)
{
  ...
  UNPACK_DECL(903,TAMEX3_HEADER,header);
  // select several
  ...
  for ( ; ; )
  {
    ...
    {
    uint32 __match_peek;
    PEEK_FROM_BUFFER(906,uint32,__match_peek);
    // differ = 00000000 :
    uint32 __match_index = 0;
    static const sint8 __match_index_array[1] = { 1, };
    __match_no = __match_index_array[__match_index];
    ...
    {
      case 1:
        CHECK_SPURIOUS_MATCH_DECL(905,spurious_match_abort_loop_2,TAMEX3_PADDING);
        UNPACK_DECL(905,TAMEX3_PADDING,padding1);
        break;
    }
  }
  ...
  for ( ; ; )
  {
    ...
    {
      case 1:
        CHECK_SPURIOUS_MATCH_DECL(908,spurious_match_abort_loop_3,TAMEX3_SFP,/*sfp*/2,/*card*/0);
        UNPACK_DECL(908,TAMEX3_SFP,tamex_1,/*sfp*/2,/*card*/0);
        break;
      case 2:
        CHECK_SPURIOUS_MATCH_DECL(909,spurious_match_abort_loop_3,TAMEX3_SFP,/*sfp*/2,/*card*/1);
        UNPACK_DECL(909,TAMEX3_SFP,tamex_2,/*sfp*/2,/*card*/1);
        break;
    }
  }
  ...
  for ( ; ; )
  {
    ...
    {
    uint32 __match_peek;
    PEEK_FROM_BUFFER(913,uint32,__match_peek);
    // differ = 00000000 :
    uint32 __match_index = 0;
    static const sint8 __match_index_array[1] = { 1, };
    __match_no = __match_index_array[__match_index];
    ...
    {
      case 1:
        CHECK_SPURIOUS_MATCH_DECL(912,spurious_match_abort_loop_4,TAMEX3_PADDING);
        UNPACK_DECL(912,TAMEX3_PADDING,padding2);
        break;
    }
  }
  ...
  for ( ; ; )
  {
    ...
    {
      case 1:
        UNPACK_DECL(915,TAMEX3_SFP,tamex_3,/*sfp*/3,/*card*/0);
        break;
      case 2:
        UNPACK_DECL(916,TAMEX3_SFP,tamex_4,/*sfp*/3,/*card*/1);
        break;
    }
  }
}
...
{
  // land_vme = LAND_STD_VME();
  UNPACK_DECL(922,LAND_STD_VME,land_vme);
  // barrier = BARRIER();
  UNPACK_DECL(923,BARRIER,barrier);
  // select several
  ...
  for ( ; ; )
  {
    ...
    {
    uint32 __match_peek;
    PEEK_FROM_BUFFER(928,uint32,__match_peek);
    // differ = 00000003 : 0 1
    ...
    {
      case 1:
        UNPACK_DECL(925,VME_GSI_VFTX2_7PS,vftx2_1,/*id*/1);
        break;
      case 2:
        UNPACK_DECL(926,VME_GSI_VFTX2_7PS,vftx2_2,/*id*/2);
        break;
      case 3:
        UNPACK_DECL(927,VME_GSI_VFTX2_7PS,vftx2_3,/*id*/3);
        break;
    }
  }
}
...
void tpat_subev::__unpack(__data_src_t &__buffer)
{
  ...
  UNPACK_DECL(933,TRLOII_TPAT,tpat,/*id*/207);
}
...
void tracking_febex_subev::__unpack(__data_src_t &__buffer)
{
  ...
  for ( ; ; )
  {
    ...
    switch (__match_no)
    {
      ...
      case 10:
        ...
        break;
      case 11:
        CHECK_SPURIOUS_MATCH_DECL(827,spurious_match_abort_loop_5,FEBEX_NOTRACE,/*sfp*/0,/*card*/10);
        UNPACK_DECL(827,FEBEX_NOTRACE,febex_0[10],/*sfp*/0,/*card*/10);
        break;
      case 12:
        CHECK_SPURIOUS_MATCH_DECL(828,spurious_match_abort_loop_5,FEBEX_NOTRACE,/*sfp*/0,/*card*/11);
        UNPACK_DECL(828,FEBEX_NOTRACE,febex_0[11],/*sfp*/0,/*card*/11);
        break;
      case 13:
        CHECK_SPURIOUS_MATCH_DECL(829,spurious_match_abort_loop_5,FEBEX_NOTRACE,/*sfp*/0,/*card*/12);
        UNPACK_DECL(829,FEBEX_NOTRACE,febex_0[12],/*sfp*/0,/*card*/12);
        break;
      case 14:
        CHECK_SPURIOUS_MATCH_DECL(830,spurious_match_abort_loop_5,FEBEX_NOTRACE,/*sfp*/0,/*card*/13);
        UNPACK_DECL(830,FEBEX_NOTRACE,febex_0[13],/*sfp*/0,/*card*/13);
        break;
      case 15:
        CHECK_SPURIOUS_MATCH_DECL(831,spurious_match_abort_loop_5,FEBEX_NOTRACE,/*sfp*/0,/*card*/14);
        UNPACK_DECL(831,FEBEX_NOTRACE,febex_0[14],/*sfp*/0,/*card*/14);
        break;
      case 16:
        CHECK_SPURIOUS_MATCH_DECL(832,spurious_match_abort_loop_5,FEBEX_NOTRACE,/*sfp*/0,/*card*/15);
        UNPACK_DECL(832,FEBEX_NOTRACE,febex_0[15],/*sfp*/0,/*card*/15);
        break;
    }
  }
  spurious_match_abort_loop_5:;
  // header2 = FEBEX_EVENTHEADER();
  UNPACK_DECL(834,FEBEX_EVENTHEADER,header2);
  // select several
  ...
  for ( ; ; )
  {
    if (__buffer.empty()) break;
    int __match_no = 0;
    // optimized match 1: FEBEX_NOTRACE febex_1[0]: (s32) => (0xfffff0ff,0xff001034)
    // optimized match 2: FEBEX_NOTRACE febex_1[1]: (s32) => (0xfffff0ff,0xff011034)
    // optimized match 3: FEBEX_NOTRACE febex_1[2]: (s32) => (0xfffff0ff,0xff021034)
    // optimized match 4: FEBEX_NOTRACE febex_1[3]: (s32) => (0xfffff0ff,0xff031034)
    // optimized match 5: FEBEX_NOTRACE febex_1[4]: (s32) => (0xfffff0ff,0xff041034)
    // optimized match 6: FEBEX_NOTRACE febex_1[5]: (s32) => (0xfffff0ff,0xff051034)
    // optimized match 7: FEBEX_NOTRACE febex_1[6]: (s32) => (0xfffff0ff,0xff061034)
    // optimized match 8: FEBEX_NOTRACE febex_1[7]: (s32) => (0xfffff0ff,0xff071034)
    // optimized match 9: FEBEX_NOTRACE febex_1[8]: (s32) => (0xfffff0ff,0xff081034)
    // optimized match 10: FEBEX_NOTRACE febex_1[9]: (s32) => (0xfffff0ff,0xff091034)
    // optimized match 11: FEBEX_NOTRACE febex_1[10]: (s32) => (0xfffff0ff,0xff0a1034)
    // optimized match 12: FEBEX_NOTRACE febex_1[11]: (s32) => (0xfffff0ff,0xff0b1034)
    // optimized match 13: FEBEX_NOTRACE febex_1[12]: (s32) => (0xfffff0ff,0xff0c1034)
    // optimized match 14: FEBEX_NOTRACE febex_1[13]: (s32) => (0xfffff0ff,0xff0d1034)
    // optimized match 15: FEBEX_NOTRACE febex_1[14]: (s32) => (0xfffff0ff,0xff0e1034)
    // optimized match 16: FEBEX_NOTRACE febex_1[15]: (s32) => (0xfffff0ff,0xff0f1034)
    {
    uint32 __match_peek;
    ...
    {
      case 1:
        UNPACK_DECL(836,FEBEX_NOTRACE,febex_1[0],/*sfp*/1,/*card*/0);
        break;
      case 2:
        UNPACK_DECL(837,FEBEX_NOTRACE,febex_1[1],/*sfp*/1,/*card*/1);
        break;
      case 3:
        UNPACK_DECL(838,FEBEX_NOTRACE,febex_1[2],/*sfp*/1,/*card*/2);
        break;
      case 4:
        UNPACK_DECL(839,FEBEX_NOTRACE,febex_1[3],/*sfp*/1,/*card*/3);
        break;
      case 5:
        UNPACK_DECL(840,FEBEX_NOTRACE,febex_1[4],/*sfp*/1,/*card*/4);
        break;
      case 6:
        UNPACK_DECL(841,FEBEX_NOTRACE,febex_1[5],/*sfp*/1,/*card*/5);
        break;
      case 7:
        UNPACK_DECL(842,FEBEX_NOTRACE,febex_1[6],/*sfp*/1,/*card*/6);
        break;
      case 8:
        UNPACK_DECL(843,FEBEX_NOTRACE,febex_1[7],/*sfp*/1,/*card*/7);
        break;
      case 9:
        UNPACK_DECL(844,FEBEX_NOTRACE,febex_1[8],/*sfp*/1,/*card*/8);
        break;
      case 10:
        UNPACK_DECL(845,FEBEX_NOTRACE,febex_1[9],/*sfp*/1,/*card*/9);
        break;
      case 11:
        UNPACK_DECL(846,FEBEX_NOTRACE,febex_1[10],/*sfp*/1,/*card*/10);
        break;
      case 12:
        UNPACK_DECL(847,FEBEX_NOTRACE,febex_1[11],/*sfp*/1,/*card*/11);
        break;
      case 13:
        UNPACK_DECL(848,FEBEX_NOTRACE,febex_1[12],/*sfp*/1,/*card*/12);
        break;
      case 14:
        UNPACK_DECL(849,FEBEX_NOTRACE,febex_1[13],/*sfp*/1,/*card*/13);
        break;
      case 15:
        UNPACK_DECL(850,FEBEX_NOTRACE,febex_1[14],/*sfp*/1,/*card*/14);
        break;
      case 16:
        UNPACK_DECL(851,FEBEX_NOTRACE,febex_1[15],/*sfp*/1,/*card*/15);
        break;
    }
  }
}
