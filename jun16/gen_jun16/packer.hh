...
void PACKER_fitest_febex_subev::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(858,FEBEX_EVENTHEADER,header);
  // select several

    // padding = FEBEX_PADDING();
  {
    PACK_DECL(860,FEBEX_PADDING,padding);
  }
  // select several
  ...
  {
    PACK_DECL(863,FEBEX_NOTRACE,febex[0],/*sfp*/3,/*card*/0);
    PACK_DECL(864,FEBEX_NOTRACE,febex[1],/*sfp*/3,/*card*/1);
    PACK_DECL(865,FEBEX_NOTRACE,febex[2],/*sfp*/3,/*card*/2);
    PACK_DECL(866,FEBEX_NOTRACE,febex[3],/*sfp*/3,/*card*/3);
    PACK_DECL(867,FEBEX_NOTRACE,febex[4],/*sfp*/3,/*card*/4);
    PACK_DECL(868,FEBEX_NOTRACE,febex[5],/*sfp*/3,/*card*/5);
    PACK_DECL(869,FEBEX_NOTRACE,febex[6],/*sfp*/3,/*card*/6);
    PACK_DECL(870,FEBEX_NOTRACE,febex[7],/*sfp*/3,/*card*/7);
    PACK_DECL(871,FEBEX_TRACE,febextrace[0],/*sfp*/3,/*card*/0);
    PACK_DECL(872,FEBEX_TRACE,febextrace[1],/*sfp*/3,/*card*/1);
    PACK_DECL(873,FEBEX_TRACE,febextrace[2],/*sfp*/3,/*card*/2);
    PACK_DECL(874,FEBEX_TRACE,febextrace[3],/*sfp*/3,/*card*/3);
    PACK_DECL(875,FEBEX_TRACE,febextrace[4],/*sfp*/3,/*card*/4);
    PACK_DECL(876,FEBEX_TRACE,febextrace[5],/*sfp*/3,/*card*/5);
    PACK_DECL(877,FEBEX_TRACE,febextrace[6],/*sfp*/3,/*card*/6);
    PACK_DECL(878,FEBEX_TRACE,febextrace[7],/*sfp*/3,/*card*/7);
  }
}
...
void PACKER_straw_vme_subev::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(885,VME_GSI_VFTX2_STRAW,vftx2,/*id*/0);
  }
}
...
{
  // land_vme = LAND_STD_VME();
  PACK_DECL(891,LAND_STD_VME,land_vme);
  // barrier = BARRIER();
  PACK_DECL(893,BARRIER,barrier);
  // select several

    // vftx2 = VME_GSI_VFTX2_LT(id=1);
    // madc32 = VME_MESYTEC_MADC32(geom=2);
  {
    PACK_DECL(895,VME_GSI_VFTX2_LT,vftx2,/*id*/1);
    PACK_DECL(896,VME_MESYTEC_MADC32,madc32,/*geom*/2);
  }
}
...
void PACKER_tofd_tamex_subev::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(903,TAMEX3_HEADER,header);
  // select several

    // padding1 = TAMEX3_PADDING();
  {
    PACK_DECL(905,TAMEX3_PADDING,padding1);
  }
  // select several
  ...
  {
    PACK_DECL(908,TAMEX3_SFP,tamex_1,/*sfp*/2,/*card*/0);
    PACK_DECL(909,TAMEX3_SFP,tamex_2,/*sfp*/2,/*card*/1);
  }
  // select several

    // padding2 = TAMEX3_PADDING();
  {
    PACK_DECL(912,TAMEX3_PADDING,padding2);
  }
  // select several
  ...
  {
    PACK_DECL(915,TAMEX3_SFP,tamex_3,/*sfp*/3,/*card*/0);
    PACK_DECL(916,TAMEX3_SFP,tamex_4,/*sfp*/3,/*card*/1);
  }
}
...
{
  // land_vme = LAND_STD_VME();
  PACK_DECL(922,LAND_STD_VME,land_vme);
  // barrier = BARRIER();
  PACK_DECL(923,BARRIER,barrier);
  // select several
  ...
  {
    PACK_DECL(925,VME_GSI_VFTX2_7PS,vftx2_1,/*id*/1);
    PACK_DECL(926,VME_GSI_VFTX2_7PS,vftx2_2,/*id*/2);
    PACK_DECL(927,VME_GSI_VFTX2_7PS,vftx2_3,/*id*/3);
  }
}
...
void PACKER_tpat_subev::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(933,TRLOII_TPAT,tpat,/*id*/207);
}
...
void PACKER_tracking_febex_subev::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(815,FEBEX_EVENTHEADER,header0);
  // select several
  ...
  {
    PACK_DECL(817,FEBEX_NOTRACE,febex_0[0],/*sfp*/0,/*card*/0);
    PACK_DECL(818,FEBEX_NOTRACE,febex_0[1],/*sfp*/0,/*card*/1);
    PACK_DECL(819,FEBEX_NOTRACE,febex_0[2],/*sfp*/0,/*card*/2);
    PACK_DECL(820,FEBEX_NOTRACE,febex_0[3],/*sfp*/0,/*card*/3);
    PACK_DECL(821,FEBEX_NOTRACE,febex_0[4],/*sfp*/0,/*card*/4);
    PACK_DECL(822,FEBEX_NOTRACE,febex_0[5],/*sfp*/0,/*card*/5);
    PACK_DECL(823,FEBEX_NOTRACE,febex_0[6],/*sfp*/0,/*card*/6);
    PACK_DECL(824,FEBEX_NOTRACE,febex_0[7],/*sfp*/0,/*card*/7);
    PACK_DECL(825,FEBEX_NOTRACE,febex_0[8],/*sfp*/0,/*card*/8);
    PACK_DECL(826,FEBEX_NOTRACE,febex_0[9],/*sfp*/0,/*card*/9);
    PACK_DECL(827,FEBEX_NOTRACE,febex_0[10],/*sfp*/0,/*card*/10);
    PACK_DECL(828,FEBEX_NOTRACE,febex_0[11],/*sfp*/0,/*card*/11);
    PACK_DECL(829,FEBEX_NOTRACE,febex_0[12],/*sfp*/0,/*card*/12);
    PACK_DECL(830,FEBEX_NOTRACE,febex_0[13],/*sfp*/0,/*card*/13);
    PACK_DECL(831,FEBEX_NOTRACE,febex_0[14],/*sfp*/0,/*card*/14);
    PACK_DECL(832,FEBEX_NOTRACE,febex_0[15],/*sfp*/0,/*card*/15);
  }
  // header2 = FEBEX_EVENTHEADER();
  PACK_DECL(834,FEBEX_EVENTHEADER,header2);
  // select several
  ...
  {
    PACK_DECL(836,FEBEX_NOTRACE,febex_1[0],/*sfp*/1,/*card*/0);
    PACK_DECL(837,FEBEX_NOTRACE,febex_1[1],/*sfp*/1,/*card*/1);
    PACK_DECL(838,FEBEX_NOTRACE,febex_1[2],/*sfp*/1,/*card*/2);
    PACK_DECL(839,FEBEX_NOTRACE,febex_1[3],/*sfp*/1,/*card*/3);
    PACK_DECL(840,FEBEX_NOTRACE,febex_1[4],/*sfp*/1,/*card*/4);
    PACK_DECL(841,FEBEX_NOTRACE,febex_1[5],/*sfp*/1,/*card*/5);
    PACK_DECL(842,FEBEX_NOTRACE,febex_1[6],/*sfp*/1,/*card*/6);
    PACK_DECL(843,FEBEX_NOTRACE,febex_1[7],/*sfp*/1,/*card*/7);
    PACK_DECL(844,FEBEX_NOTRACE,febex_1[8],/*sfp*/1,/*card*/8);
    PACK_DECL(845,FEBEX_NOTRACE,febex_1[9],/*sfp*/1,/*card*/9);
    PACK_DECL(846,FEBEX_NOTRACE,febex_1[10],/*sfp*/1,/*card*/10);
    PACK_DECL(847,FEBEX_NOTRACE,febex_1[11],/*sfp*/1,/*card*/11);
    PACK_DECL(848,FEBEX_NOTRACE,febex_1[12],/*sfp*/1,/*card*/12);
    PACK_DECL(849,FEBEX_NOTRACE,febex_1[13],/*sfp*/1,/*card*/13);
    PACK_DECL(850,FEBEX_NOTRACE,febex_1[14],/*sfp*/1,/*card*/14);
    PACK_DECL(851,FEBEX_NOTRACE,febex_1[15],/*sfp*/1,/*card*/15);
  }
}
