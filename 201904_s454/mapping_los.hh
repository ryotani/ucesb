// LOS timestamps.
SIGNAL(TIMESTAMP_MASTER_ID, los_ts.ts.subsystem_id, DATA12);
SIGNAL(TIMESTAMP_MASTER_WR_T1, los_ts.ts.t1, DATA16);
SIGNAL(TIMESTAMP_MASTER_WR_T2, los_ts.ts.t2, DATA16);
SIGNAL(TIMESTAMP_MASTER_WR_T3, los_ts.ts.t3, DATA16);
SIGNAL(TIMESTAMP_MASTER_WR_T4, los_ts.ts.t4, DATA16);
