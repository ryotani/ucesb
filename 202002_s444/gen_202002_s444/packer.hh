...
void PACKER_FEBEX_EVENTHEADER::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(1063,FEBEX_GOOD_EVENTHEADER,good);
    PACK_DECL(1064,FEBEX_BAD_EVENTHEADER,bad);
  }
}
...
void PACKER_TAMEX3_FH_SFP::__packer(__data_dest_t &__buffer,uint32 sfp,uint32 card)
{
  ...
  // select optional
    ...
    // data = TAMEX3_FH_DATA();
  {
    PACK_DECL(1055,TAMEX3_FH_DATA,data);
  }
}
...
/** BEGIN_PACKER *******************************************************
 *
 * Event packer for VME_SIS_3820_SCALER.
 *
 * Do not edit - automatically generated.
 */
...
template<typename __data_dest_t>
void PACKER_VME_SIS_3820_SCALER::__packer(__data_dest_t &__buffer,uint32 geom)
{
  // MEMBER(DATA32 data[32] ZERO_SUPPRESS);
...
FORCE_IMPL_DATA_SRC_FCN_ARG(void,VME_SIS_3820_SCALER::__packer,uint32 geom);
...
void PACKER_fibsipm_data::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(2089,LAND_STD_VME,land_vme);
  // select several
  ...
  {
    PACK_DECL(2091,GSI_CLOCKTDC_ITEM,ctdc[0],/*sfp*/0,/*tdc*/0);
    PACK_DECL(2092,GSI_CLOCKTDC_ITEM,ctdc[1],/*sfp*/0,/*tdc*/1);
    PACK_DECL(2093,GSI_CLOCKTDC_ITEM,ctdc[2],/*sfp*/0,/*tdc*/2);
    PACK_DECL(2094,GSI_CLOCKTDC_ITEM,ctdc[3],/*sfp*/0,/*tdc*/3);
  }
}
...
void PACKER_neuland_sfp::__packer(__data_dest_t &__buffer,uint32 sfp)
{
  ...
  {
    PACK_DECL(1960,TAMEX3_FH_SFP,card[0],/*sfp*/sfp,/*card*/0);
    PACK_DECL(1961,TAMEX3_FH_SFP,card[1],/*sfp*/sfp,/*card*/1);
    PACK_DECL(1962,TAMEX3_FH_SFP,card[2],/*sfp*/sfp,/*card*/2);
    PACK_DECL(1963,TAMEX3_FH_SFP,card[3],/*sfp*/sfp,/*card*/3);
    PACK_DECL(1964,TAMEX3_FH_SFP,card[4],/*sfp*/sfp,/*card*/4);
    PACK_DECL(1965,TAMEX3_FH_SFP,card[5],/*sfp*/sfp,/*card*/5);
    PACK_DECL(1966,TAMEX3_FH_SFP,card[6],/*sfp*/sfp,/*card*/6);
    PACK_DECL(1967,TAMEX3_FH_SFP,card[7],/*sfp*/sfp,/*card*/7);
    PACK_DECL(1968,TAMEX3_FH_SFP,card[8],/*sfp*/sfp,/*card*/8);
    PACK_DECL(1969,TAMEX3_FH_SFP,card[9],/*sfp*/sfp,/*card*/9);
    PACK_DECL(1970,TAMEX3_FH_SFP,card[10],/*sfp*/sfp,/*card*/10);
    PACK_DECL(1971,TAMEX3_FH_SFP,card[11],/*sfp*/sfp,/*card*/11);
    PACK_DECL(1972,TAMEX3_FH_SFP,card[12],/*sfp*/sfp,/*card*/12);
    PACK_DECL(1973,TAMEX3_FH_SFP,card[13],/*sfp*/sfp,/*card*/13);
    PACK_DECL(1974,TAMEX3_FH_SFP,card[14],/*sfp*/sfp,/*card*/14);
    PACK_DECL(1975,TAMEX3_FH_SFP,card[15],/*sfp*/sfp,/*card*/15);
    PACK_DECL(1976,TAMEX3_FH_SFP,card[16],/*sfp*/sfp,/*card*/16);
    PACK_DECL(1977,TAMEX3_FH_SFP,card[17],/*sfp*/sfp,/*card*/17);
    PACK_DECL(1978,TAMEX3_FH_SFP,card[18],/*sfp*/sfp,/*card*/18);
    PACK_DECL(1979,TAMEX3_FH_SFP,card[19],/*sfp*/sfp,/*card*/19);
    PACK_DECL(1980,TAMEX3_FH_SFP,card[20],/*sfp*/sfp,/*card*/20);
    PACK_DECL(1981,TAMEX3_FH_SFP,card[21],/*sfp*/sfp,/*card*/21);
    PACK_DECL(1982,TAMEX3_FH_SFP,card[22],/*sfp*/sfp,/*card*/22);
    PACK_DECL(1983,TAMEX3_FH_SFP,card[23],/*sfp*/sfp,/*card*/23);
    PACK_DECL(1984,TAMEX3_FH_SFP,card[24],/*sfp*/sfp,/*card*/24);
    PACK_DECL(1985,TAMEX3_FH_SFP,card[25],/*sfp*/sfp,/*card*/25);
    PACK_DECL(1986,TAMEX3_FH_SFP,card[26],/*sfp*/sfp,/*card*/26);
    PACK_DECL(1987,TAMEX3_FH_SFP,card[27],/*sfp*/sfp,/*card*/27);
    PACK_DECL(1988,TAMEX3_FH_SFP,card[28],/*sfp*/sfp,/*card*/28);
    PACK_DECL(1989,TAMEX3_FH_SFP,card[29],/*sfp*/sfp,/*card*/29);
    PACK_DECL(1990,TAMEX3_FH_SFP,card[30],/*sfp*/sfp,/*card*/30);
    PACK_DECL(1991,TAMEX3_FH_SFP,card[31],/*sfp*/sfp,/*card*/31);
    PACK_DECL(1992,TAMEX3_FH_SFP,card[32],/*sfp*/sfp,/*card*/32);
    PACK_DECL(1993,TAMEX3_FH_SFP,card[33],/*sfp*/sfp,/*card*/33);
    PACK_DECL(1994,TAMEX3_FH_SFP,card[34],/*sfp*/sfp,/*card*/34);
  }
}
...
{
  // land_vme = LAND_STD_VME();
  PACK_DECL(2000,LAND_STD_VME,land_vme);
  // select several

    // padding0 = TAMEX3_PADDING();
  {
    PACK_DECL(2002,TAMEX3_PADDING,padding0);
  }
  // sfp[0] = neuland_sfp(sfp=0);
  PACK_DECL(2004,neuland_sfp,sfp[0],/*sfp*/0);
}
...
{
  // land_vme = LAND_STD_VME();
  PACK_DECL(2112,LAND_STD_VME,land_vme);
  // vftx21 = VME_GSI_VFTX2_7PS(id=0);
  PACK_DECL(2113,VME_GSI_VFTX2_7PS,vftx21,/*id*/0);
  // mqdc = VME_MESYTEC_MQDC32(geom=1);
  PACK_DECL(2114,VME_MESYTEC_MQDC32,mqdc,/*geom*/1);
  // barrier = BARRIER();
  PACK_DECL(2115,BARRIER,barrier);
}
...
{
  // land_vme = LAND_STD_VME();
  PACK_DECL(2144,LAND_STD_VME,land_vme);
  // select several

    // vftx21 = VME_GSI_VFTX2_7PS(id=0);
  {
    PACK_DECL(2146,VME_GSI_VFTX2_7PS,vftx21,/*id*/0);
  }
}
...
{
  // land_vme = LAND_STD_VME();
  PACK_DECL(2044,LAND_STD_VME,land_vme);
  // select several
  ...
  {
    PACK_DECL(2046,VME_MESYTEC_VMMR8,vmmr8,/*geom*/0);
    PACK_DECL(2047,VME_MESYTEC_MADC32,madc32[0],/*geom*/1);
    PACK_DECL(2048,VME_MESYTEC_MADC32,madc32[1],/*geom*/2);
  }
}
...
{
  // land_vme = LAND_STD_VME();
  PACK_DECL(2025,LAND_STD_VME,land_vme);
  // select several
  ...
  {
    PACK_DECL(2027,VME_GSI_VFTX2_7PS,vftx2[0],/*id*/0);
    PACK_DECL(2028,VME_GSI_VFTX2_7PS,vftx2[1],/*id*/1);
    PACK_DECL(2029,VME_GSI_VFTX2_7PS,vftx2[2],/*id*/2);
    PACK_DECL(2030,VME_GSI_VFTX2_7PS,vftx2[3],/*id*/3);
    PACK_DECL(2031,VME_SIS_3820_SCALER,sis3820scaler[0],/*geom*/4);
    PACK_DECL(2032,BARRIER,b);
    PACK_DECL(2033,VME_SIS_3820_SCALER,sis3820scaler[1],/*geom*/5);
  }
}
...
{
  // land_vme = LAND_STD_VME();
  PACK_DECL(2074,LAND_STD_VME,land_vme);
  // select several

    // mdpp = VME_MESYTEC_MDPP16(geom=0);
    // vmmr8 = VME_MESYTEC_VMMR8(geom=1);
  {
    PACK_DECL(2076,VME_MESYTEC_MDPP16,mdpp,/*geom*/0);
    PACK_DECL(2077,VME_MESYTEC_VMMR8,vmmr8,/*geom*/1);
  }
}
...
{
  // land_vme = LAND_STD_VME();
  PACK_DECL(2059,LAND_STD_VME,land_vme);
  // select several
  ...
  {
    PACK_DECL(2061,VME_MESYTEC_MDPP16,mdpp16[0],/*geom*/0);
    PACK_DECL(2062,VME_MESYTEC_MDPP16,mdpp16[1],/*geom*/1);
    PACK_DECL(2063,VME_SIS_3820_SCALER,sis3820scaler,/*geom*/2);
  }
}
...
/** BEGIN_PACKER *******************************************************
 *
 * Event packer for CALIFA_MESSEL.
 *
 * Do not edit - automatically generated.
 */
...
template<typename __data_dest_t>
void PACKER_CALIFA_MESSEL::__packer(__data_dest_t &__buffer)
{
  // ts = TIMESTAMP_WHITERABBIT(id=0xa00);
  PACK_DECL(1916,TIMESTAMP_WHITERABBIT,ts,/*id*/0xa00);
  // select several

    // febex3 = FEBEX3_CALIFA_BASE();
  {
    PACK_DECL(1918,FEBEX3_CALIFA_BASE,febex3);
  }
}
FORCE_IMPL_DATA_SRC_FCN(void,CALIFA_MESSEL::__packer);

/** END_PACKER ********************************************************/
/** BEGIN_PACKER *******************************************************
 *
 * Event packer for CALIFA_WIXHAUSEN.
 *
 * Do not edit - automatically generated.
 */
...
template<typename __data_dest_t>
void PACKER_CALIFA_WIXHAUSEN::__packer(__data_dest_t &__buffer)
{
  // ts = TIMESTAMP_WHITERABBIT(id=0xb00);
  PACK_DECL(1925,TIMESTAMP_WHITERABBIT,ts,/*id*/0xb00);
  // select several

    // febex3 = FEBEX3_CALIFA_BASE();
  {
    PACK_DECL(1927,FEBEX3_CALIFA_BASE,febex3);
  }
}
FORCE_IMPL_DATA_SRC_FCN(void,CALIFA_WIXHAUSEN::__packer);
...
void PACKER_fibsipm_subev::__packer(__data_dest_t &__buffer)
{
  // select several
    ...
    // data = fibsipm_data();
  {
    PACK_DECL(2101,fibsipm_data,data);
  }
}
...
void PACKER_lmu_subev::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(1943,TRLOII_LMU_SCALERS,scalers,/*id*/199);
  // pulser = MEGA_PULSER();
  PACK_DECL(1944,MEGA_PULSER,pulser);
}
...
/** BEGIN_PACKER *******************************************************
 *
 * Event packer for main_tpat_subev.
 *
 * Do not edit - automatically generated.
 */
...
template<typename __data_dest_t>
void PACKER_main_tpat_subev::__packer(__data_dest_t &__buffer)
{
  // land_vme = LAND_STD_VME();
  PACK_DECL(2132,LAND_STD_VME,land_vme);
  // tpat = TRLOII_TPAT(id=207);
  PACK_DECL(2133,TRLOII_TPAT,tpat,/*id*/207);
}
FORCE_IMPL_DATA_SRC_FCN(void,main_tpat_subev::__packer);

/** END_PACKER ********************************************************/
/** BEGIN_PACKER *******************************************************
 *
 * Event packer for main_wr.
 *
 * Do not edit - automatically generated.
 */
...
// SUBEVENT(main_wr)
template<typename __data_dest_t>
void PACKER_main_wr::__packer(__data_dest_t &__buffer)
{
  // ts = TIMESTAMP_WHITERABBIT(id=0x300);
  PACK_DECL(1933,TIMESTAMP_WHITERABBIT,ts,/*id*/0x300);
}
FORCE_IMPL_DATA_SRC_FCN(void,main_wr::__packer);
...
void PACKER_neuland_tamex_subev::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(2010,neuland_tamex_subev_data,data);
  }
}
...
void PACKER_s2_vme_subev::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(2121,s2_vme_subev_data,data);
  }
}
...
{
  // land_vme = LAND_STD_VME();
  PACK_DECL(2138,LAND_STD_VME,land_vme);
  // tpat = TRLOII_TPAT(id=207);
  PACK_DECL(2139,TRLOII_TPAT,tpat,/*id*/207);
}
...
void PACKER_s8_vme_subev::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(2153,s8_vme_subev_data,data);
  }
}
...
void PACKER_s8_wr::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(2127,TIMESTAMP_WHITERABBIT,ts,/*id*/0x800);
}
...
void PACKER_sofia_mwpc_subev::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(2054,sofia_mwpc_subev_data,data);
  }
}
...
/** BEGIN_PACKER *******************************************************
 *
 * Event packer for sofia_sampler_subev.
 *
 * Do not edit - automatically generated.
 */
...
template<typename __data_dest_t>
void PACKER_sofia_sampler_subev::__packer(__data_dest_t &__buffer)
{
  // land_vme = LAND_STD_VME();
  PACK_DECL(2016,LAND_STD_VME,land_vme);
  // select several

    // sofstart = TRLOII_SAMPLER(mark=0x1050);
    // ms = TRLOII_SAMPLER(mark=0x1060);
  {
    PACK_DECL(2018,TRLOII_SAMPLER,sofstart,/*mark*/0x1050);
    PACK_DECL(2019,TRLOII_SAMPLER,ms,/*mark*/0x1060);
  }
}
FORCE_IMPL_DATA_SRC_FCN(void,sofia_sampler_subev::__packer);
...
void PACKER_sofia_tof_subev::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(2039,sofia_tof_subev_data,data);
  }
}
...
void PACKER_sofia_trim_subev::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(2083,sofia_trim_subev_data,data);
  }
}
...
void PACKER_sofia_twim_subev::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(2069,sofia_twim_subev_data,data);
  }
}
...
// SUBEVENT(sofia_wr)
template<typename __data_dest_t>
void PACKER_sofia_wr::__packer(__data_dest_t &__buffer)
{
  // ts = TIMESTAMP_WHITERABBIT(id=0x500);
  PACK_DECL(1949,TIMESTAMP_WHITERABBIT,ts,/*id*/0x500);
}
FORCE_IMPL_DATA_SRC_FCN(void,sofia_wr::__packer);
...
void PACKER_wr_neuland::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(1954,TIMESTAMP_WHITERABBIT,ts,/*id*/0x900);
}
...
void PACKER_wr_s2::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(2107,TIMESTAMP_WHITERABBIT,ts,/*id*/0x200);
}
