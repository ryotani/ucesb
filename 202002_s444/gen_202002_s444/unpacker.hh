...
void s2_vme_subev_data::__unpack(__data_src_t &__buffer)
{
  ...
  UNPACK_DECL(2113,VME_GSI_VFTX2_7PS,vftx21,/*id*/0);
  // mqdc = VME_MESYTEC_MQDC32(geom=1);
  UNPACK_DECL(2114,VME_MESYTEC_MQDC32,mqdc,/*geom*/1);
  // barrier = BARRIER();
  UNPACK_DECL(2115,BARRIER,barrier);
}
...
void sofia_wr::__unpack(__data_src_t &__buffer)
{
  ...
  UNPACK_DECL(1949,TIMESTAMP_WHITERABBIT,ts,/*id*/0x500);
}
