...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(fib_ctdc0_fib3_subev_data)::FCNCALL_NAME(fib_ctdc0_fib3_subev_data)
{
  FCNCALL_INIT;
  // GSI_CLOCKTDC_PADDING padding;
  {
  ...
  // GSI_CLOCKTDC_ITEM ctdc3[4];
  {
  FCNCALL_SUBNAME("ctdc3");
  FCNCALL_FOR(__i0,4)
  {
    FCNCALL_SUBINDEX(__i0);
    { FCNCALL_CALL_CTRL_WRAP_ARRAY(ctdc3__i0,,__i0,ctdc3[__i0].FCNCALL_CALL(ctdc3[__i0])); }
    FCNCALL_SUBINDEX_END(__i0);
  }
  FCNCALL_SUBNAME_END;
  }
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(fib_ctdc0_subev_data)::FCNCALL_NAME(fib_ctdc0_subev_data)
{
  FCNCALL_INIT;
  // GSI_CLOCKTDC_PADDING padding;
  {
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(fib_tamex_data)::FCNCALL_NAME(fib_tamex_data)
{
  FCNCALL_INIT;
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(lmu_scalers_data)::FCNCALL_NAME(lmu_scalers_data)
{
  FCNCALL_INIT;
  // uint32 beam;
  {
  FCNCALL_SUBNAME("beam");
  { FCNCALL_CALL_CTRL_WRAP(beam,FCNCALL_CALL_TYPE(uint32,beam)); }
  FCNCALL_SUBNAME_END;
  }
  FCNCALL_RET;
}
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(los_sampler_data)::FCNCALL_NAME(los_sampler_data)
{
  FCNCALL_INIT;
  // uint32 beam;
  {
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(los_scalers_data)::FCNCALL_NAME(los_scalers_data)
{
  FCNCALL_INIT;
  // uint32 beam;
  {
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(master_monitor_subev_data)::FCNCALL_NAME(master_monitor_subev_data)
{
  FCNCALL_INIT;
  // VME_CAEN_V830 v830;
  {
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(master_scalers_data)::FCNCALL_NAME(master_scalers_data)
{
  FCNCALL_INIT;
  // uint32 mega;
  {
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(neuland_tamex_subev_data_swapped)::FCNCALL_NAME(neuland_tamex_subev_data_swapped)
{
  FCNCALL_INIT;
  // TAMEX3_PADDING padding0;
  {
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(neuland_window)::FCNCALL_NAME(neuland_window)
{
  FCNCALL_INIT;
  // uint32 window;
  {
  FCNCALL_SUBNAME("window");
  { FCNCALL_CALL_CTRL_WRAP(window,FCNCALL_CALL_TYPE(uint32,window)); }
  FCNCALL_SUBNAME_END;
  }
  FCNCALL_RET;
}
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(tofd_tamex_subev_data)::FCNCALL_NAME(tofd_tamex_subev_data)
{
  FCNCALL_INIT;
  // TAMEX3_PADDING padding;
  {
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(ams_siderem_subev)::FCNCALL_NAME(ams_siderem_subev)
{
  FCNCALL_INIT;
  FCNCALL_CALL_CTRL_WRAP(unpack_subevent_base,FCNCALL_CLASS_NAME(unpack_subevent_base)::FCNCALL_CALL_BASE());
  // EXT_SST sst[4];
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(fib_ctdc0_fib3_subev)::FCNCALL_NAME(fib_ctdc0_fib3_subev)
{
  FCNCALL_INIT;
  FCNCALL_CALL_CTRL_WRAP(unpack_subevent_base,FCNCALL_CLASS_NAME(unpack_subevent_base)::FCNCALL_CALL_BASE());
  // fib_ctdc0_fib3_subev_data data;
  {
  FCNCALL_SUBNAME("data");
  { FCNCALL_CALL_CTRL_WRAP(data,data.FCNCALL_CALL(data)); }
  FCNCALL_SUBNAME_END;
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(fib_ctdc0_subev)::FCNCALL_NAME(fib_ctdc0_subev)
{
  FCNCALL_INIT;
  FCNCALL_CALL_CTRL_WRAP(unpack_subevent_base,FCNCALL_CLASS_NAME(unpack_subevent_base)::FCNCALL_CALL_BASE());
  // fib_ctdc0_subev_data data;
  {
  FCNCALL_SUBNAME("data");
  { FCNCALL_CALL_CTRL_WRAP(data,data.FCNCALL_CALL(data)); }
  FCNCALL_SUBNAME_END;
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(fib_tamex_subev)::FCNCALL_NAME(fib_tamex_subev)
{
  FCNCALL_INIT;
  FCNCALL_CALL_CTRL_WRAP(unpack_subevent_base,FCNCALL_CLASS_NAME(unpack_subevent_base)::FCNCALL_CALL_BASE());
  // fib_tamex_data data;
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(master_monitor_subev)::FCNCALL_NAME(master_monitor_subev)
{
  FCNCALL_INIT;
  FCNCALL_CALL_CTRL_WRAP(unpack_subevent_base,FCNCALL_CLASS_NAME(unpack_subevent_base)::FCNCALL_CALL_BASE());
  // master_monitor_subev_data data;
  {
  FCNCALL_SUBNAME("data");
  { FCNCALL_CALL_CTRL_WRAP(data,data.FCNCALL_CALL(data)); }
  FCNCALL_SUBNAME_END;
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(master_scalers_subev)::FCNCALL_NAME(master_scalers_subev)
{
  FCNCALL_INIT;
  FCNCALL_CALL_CTRL_WRAP(unpack_subevent_base,FCNCALL_CLASS_NAME(unpack_subevent_base)::FCNCALL_CALL_BASE());
  // master_scalers_data scalers;
  {
  FCNCALL_SUBNAME("scalers");
  { FCNCALL_CALL_CTRL_WRAP(scalers,scalers.FCNCALL_CALL(scalers)); }
  FCNCALL_SUBNAME_END;
...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(neuland_tamex_swapped_subev)::FCNCALL_NAME(neuland_tamex_swapped_subev)
{
  FCNCALL_INIT;
  FCNCALL_CALL_CTRL_WRAP(unpack_subevent_base,FCNCALL_CLASS_NAME(unpack_subevent_base)::FCNCALL_CALL_BASE());
  // neuland_tamex_subev_data_swapped data;
  {
  FCNCALL_SUBNAME("data");
  { FCNCALL_CALL_CTRL_WRAP(data,data.FCNCALL_CALL(data)); }
  FCNCALL_SUBNAME_END;
...
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(wr_100)::FCNCALL_NAME(wr_100)
{
  ...
  // WR_MULTI wr_multi;
  {
  FCNCALL_SUBNAME("wr_multi");
  { FCNCALL_CALL_CTRL_WRAP(wr_multi,wr_multi.FCNCALL_CALL(wr_multi)); }
  FCNCALL_SUBNAME_END;
  }
  FCNCALL_RET;
}
...
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(unpack_event)::FCNCALL_NAME(unpack_event)
{
  ...
  // master_scalers_subev master_scalers;
  {
  FCNCALL_SUBNAME("master_scalers");
  { FCNCALL_CALL_CTRL_WRAP(master_scalers,master_scalers.FCNCALL_CALL(master_scalers)); }
  FCNCALL_SUBNAME_END;
  }
  // master_monitor_subev master_monitor;
  {
  FCNCALL_SUBNAME("master_monitor");
  { FCNCALL_CALL_CTRL_WRAP(master_monitor,master_monitor.FCNCALL_CALL(master_monitor)); }
  FCNCALL_SUBNAME_END;
  }
  ...
  // tofd_tamex_subev tofd_tamex_1;
  {
  FCNCALL_SUBNAME("tofd_tamex_1");
  { FCNCALL_CALL_CTRL_WRAP(tofd_tamex_1,tofd_tamex_1.FCNCALL_CALL(tofd_tamex_1)); }
  FCNCALL_SUBNAME_END;
  }
  // tofd_tamex_subev tofd_tamex_2;
  {
  FCNCALL_SUBNAME("tofd_tamex_2");
  { FCNCALL_CALL_CTRL_WRAP(tofd_tamex_2,tofd_tamex_2.FCNCALL_CALL(tofd_tamex_2)); }
  FCNCALL_SUBNAME_END;
  }
  // fib_ctdc0_subev fib12_ctdc;
  {
  FCNCALL_SUBNAME("fib12_ctdc");
  { FCNCALL_CALL_CTRL_WRAP(fib12_ctdc,fib12_ctdc.FCNCALL_CALL(fib12_ctdc)); }
  FCNCALL_SUBNAME_END;
  }
  // fib_ctdc0_subev fib13_ctdc;
  {
  FCNCALL_SUBNAME("fib13_ctdc");
  { FCNCALL_CALL_CTRL_WRAP(fib13_ctdc,fib13_ctdc.FCNCALL_CALL(fib13_ctdc)); }
  FCNCALL_SUBNAME_END;
  }
  // fib_ctdc0_fib3_subev fib10_ctdc;
  {
  FCNCALL_SUBNAME("fib10_ctdc");
  { FCNCALL_CALL_CTRL_WRAP(fib10_ctdc,fib10_ctdc.FCNCALL_CALL(fib10_ctdc)); }
  FCNCALL_SUBNAME_END;
  }
  // fib_ctdc0_subev fib11_ctdc;
  {
  FCNCALL_SUBNAME("fib11_ctdc");
  { FCNCALL_CALL_CTRL_WRAP(fib11_ctdc,fib11_ctdc.FCNCALL_CALL(fib11_ctdc)); }
  FCNCALL_SUBNAME_END;
  }
  // fib_tamex_subev fib_tamex;
  {
  FCNCALL_SUBNAME("fib_tamex");
  { FCNCALL_CALL_CTRL_WRAP(fib_tamex,fib_tamex.FCNCALL_CALL(fib_tamex)); }
  FCNCALL_SUBNAME_END;
  }
  // febex_subev pspx;
  {
  FCNCALL_SUBNAME("pspx");
  { FCNCALL_CALL_CTRL_WRAP(pspx,pspx.FCNCALL_CALL(pspx)); }
  FCNCALL_SUBNAME_END;
  }
  // febex_subev pspx2;
  {
  FCNCALL_SUBNAME("pspx2");
  { FCNCALL_CALL_CTRL_WRAP(pspx2,pspx2.FCNCALL_CALL(pspx2)); }
  FCNCALL_SUBNAME_END;
  }
  // febex_subev pspx3;
  {
  FCNCALL_SUBNAME("pspx3");
  { FCNCALL_CALL_CTRL_WRAP(pspx3,pspx3.FCNCALL_CALL(pspx3)); }
  FCNCALL_SUBNAME_END;
  }
  // ams_siderem_subev ams_siderem;
  {
  FCNCALL_SUBNAME("ams_siderem");
  { FCNCALL_CALL_CTRL_WRAP(ams_siderem,ams_siderem.FCNCALL_CALL(ams_siderem)); }
  FCNCALL_SUBNAME_END;
  }
  // CALIFA califa;
  {
  ...
  // neuland_tamex_swapped_subev neuland_tamex_2;
  {
  FCNCALL_SUBNAME("neuland_tamex_2");
  { FCNCALL_CALL_CTRL_WRAP(neuland_tamex_2,neuland_tamex_2.FCNCALL_CALL(neuland_tamex_2)); }
  FCNCALL_SUBNAME_END;
  }
  // fib_ctdc0_subev fibsipm_ctdc;
  {
  FCNCALL_SUBNAME("fibsipm_ctdc");
  { FCNCALL_CALL_CTRL_WRAP(fibsipm_ctdc,fibsipm_ctdc.FCNCALL_CALL(fibsipm_ctdc)); }
  FCNCALL_SUBNAME_END;
  }
  FCNCALL_RET;
}
