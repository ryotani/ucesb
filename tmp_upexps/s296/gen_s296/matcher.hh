                                                               ...
                                                               ,uint32 high_byte)
{
  ...
  MATCH_BITS_EQUAL(1123,ch_data.edge,edge);
  MATCH_BITS_EQUAL(1124,ch_data.channel,channel);
  MATCH_BITS_EQUAL(1125,ch_data.high,high_byte);
  MATCH_UNNAMED_BITS_ZERO(1128,ch_data.u32,0x00c00000);
  return true;
  return false;
}
...
bool CROS3_REWRITE::__match(__data_src_t &__buffer,uint32 ccb_id)
{
  ...
  READ_FROM_BUFFER_FULL(791,uint32 ,h1,__h1.u32);
  MATCH_BITS_EQUAL(789,__h1.ccb_id,ccb_id);
  MATCH_UNNAMED_BITS_ZERO(791,__h1.u32,0x00080000);
  return true;
  return false;
}
...
bool DUMMY_WORD::__match(__data_src_t &__buffer)
{
  // UINT32 dummy_word;
  uint32  __dummy_word;
  READ_FROM_BUFFER(1313,uint32 ,__dummy_word);
  return true;
  return false;
}
...
bool LAND_STD_VME::__match(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(1257,uint32 ,failure,__failure.u32);
  MATCH_UNNAMED_BITS_ZERO(1257,__failure.u32,0x003fff00);
  return true;
  return false;
}
...
bool NTP64_TIME::__match(__data_src_t &__buffer)
{
  // UINT32 sec;
  uint32  __sec;
  READ_FROM_BUFFER(951,uint32 ,__sec);
  return true;
  return false;
}
...
bool NTP_MESSAGE::__match(__data_src_t &__buffer,uint32 id)
{
  ...
  READ_FROM_BUFFER_FULL(963,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(962,__header.id,id);
  MATCH_UNNAMED_BITS_ZERO(963,__header.u32,0x00fe0000);
  return true;
  return false;
}
...
bool RANDOM_TCAL_TSTAMP_CLOCK::__match(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER(1019,uint32 ,__soft_latches);
  return true;
  return false;
}
...
bool RANDOM_TCAL::__match(__data_src_t &__buffer,uint32 id)
{
  ...
  READ_FROM_BUFFER_FULL(1040,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(1039,__header.id,id);
  MATCH_UNNAMED_BITS_ZERO(1040,__header.u32,0x00f00000);
  return true;
  return false;
}
                                                  ...
                                                  ,uint32 siderem)
{
  ...
  READ_FROM_BUFFER_FULL(724,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(721,__header.siderem,siderem);
  MATCH_BITS_EQUAL(722,__header.gtb,gtb);
  MATCH_BITS_EQUAL(723,__header.sam,sam);
  return true;
  return false;
}
