                                                               ...
                                                               ,uint32 high_byte)
{
  ...
  MATCH_BITS_EQUAL(1113,ch_data.edge,edge);
  MATCH_BITS_EQUAL(1114,ch_data.channel,channel);
  MATCH_BITS_EQUAL(1115,ch_data.high,high_byte);
  MATCH_UNNAMED_BITS_ZERO(1118,ch_data.u32,0x00c00000);
  return true;
  return false;
}
...
bool CROS3_REWRITE::__match(__data_src_t &__buffer,uint32 ccb_id)
{
  ...
  READ_FROM_BUFFER_FULL(781,uint32 ,h1,__h1.u32);
  MATCH_BITS_EQUAL(779,__h1.ccb_id,ccb_id);
  MATCH_UNNAMED_BITS_ZERO(781,__h1.u32,0x00080000);
  return true;
  return false;
}
...
bool DUMMY_WORD::__match(__data_src_t &__buffer)
{
  // UINT32 dummy_word;
  uint32  __dummy_word;
  READ_FROM_BUFFER(1303,uint32 ,__dummy_word);
  return true;
  return false;
}
...
bool LAND_STD_VME::__match(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(1247,uint32 ,failure,__failure.u32);
  MATCH_UNNAMED_BITS_ZERO(1247,__failure.u32,0x003fff00);
  return true;
  return false;
}
...
bool NTP64_TIME::__match(__data_src_t &__buffer)
{
  // UINT32 sec;
  uint32  __sec;
  READ_FROM_BUFFER(941,uint32 ,__sec);
  return true;
  return false;
}
...
bool NTP_MESSAGE::__match(__data_src_t &__buffer,uint32 id)
{
  ...
  READ_FROM_BUFFER_FULL(953,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(952,__header.id,id);
  MATCH_UNNAMED_BITS_ZERO(953,__header.u32,0x00fe0000);
  return true;
  return false;
}
...
bool RANDOM_TCAL_TSTAMP_CLOCK::__match(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER(1009,uint32 ,__soft_latches);
  return true;
  return false;
}
...
bool RANDOM_TCAL::__match(__data_src_t &__buffer,uint32 id)
{
  ...
  READ_FROM_BUFFER_FULL(1030,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(1029,__header.id,id);
  MATCH_UNNAMED_BITS_ZERO(1030,__header.u32,0x00f00000);
  return true;
  return false;
}
                                                  ...
                                                  ,uint32 siderem)
{
  ...
  READ_FROM_BUFFER_FULL(720,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(717,__header.siderem,siderem);
  MATCH_BITS_EQUAL(718,__header.gtb,gtb);
  MATCH_BITS_EQUAL(719,__header.sam,sam);
  return true;
  return false;
}
