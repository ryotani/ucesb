...
class STRUCT_MIRROR_STRUCT(APV25_BLOCK)
{
public:
  STRUCT_MIRROR_ITEM_CTRL(d2);
  STRUCT_MIRROR_TYPE(raw_array_zero_suppress) < STRUCT_MIRROR_TYPE_TEMPLATE STRUCT_MIRROR_TEMPLATE_ARG(DATA12_OVERFLOW),STRUCT_MIRROR_TEMPLATE_ARG(DATA12_OVERFLOW),128> STRUCT_MIRROR_NAME(d2);
  STRUCT_MIRROR_ITEM_CTRL(d3);
  STRUCT_MIRROR_TYPE(raw_array_zero_suppress) < STRUCT_MIRROR_TYPE_TEMPLATE STRUCT_MIRROR_TEMPLATE_ARG(DATA12_OVERFLOW),STRUCT_MIRROR_TEMPLATE_ARG(DATA12_OVERFLOW),128> STRUCT_MIRROR_NAME(d3);
  ...
  public:
    ...
    {
    public:
      STRUCT_MIRROR_ITEM_CTRL(count32);
      STRUCT_MIRROR_TYPE(uint32) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(count32);
      STRUCT_MIRROR_ITEM_CTRL(trigger_counter);
      STRUCT_MIRROR_TYPE(uint32) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(trigger_counter);
      STRUCT_MIRROR_ITEM_CTRL(dsp_no);
      STRUCT_MIRROR_TYPE(uint32) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(dsp_no);
    };
  ...
  public:
    ...
    {
    public:
      STRUCT_MIRROR_ITEM_CTRL(unnamed_0_0);
      STRUCT_MIRROR_TYPE(uint32) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(unnamed_0_0);
      STRUCT_MIRROR_ITEM_CTRL(count32);
      STRUCT_MIRROR_TYPE(uint32) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(count32);
      STRUCT_MIRROR_ITEM_CTRL(unnamed_12_14);
      STRUCT_MIRROR_TYPE(uint32) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(unnamed_12_14);
      STRUCT_MIRROR_ITEM_CTRL(dummy);
      STRUCT_MIRROR_TYPE(uint32) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(dummy);
      STRUCT_MIRROR_ITEM_CTRL(se_trigger_counter);
      STRUCT_MIRROR_TYPE(uint32) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(se_trigger_counter);
      STRUCT_MIRROR_ITEM_CTRL(trigger_number);
      STRUCT_MIRROR_TYPE(uint32) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(trigger_number);
      STRUCT_MIRROR_ITEM_CTRL(unnamed_27_30);
      STRUCT_MIRROR_TYPE(uint32) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(unnamed_27_30);
      STRUCT_MIRROR_ITEM_CTRL(has_data);
      STRUCT_MIRROR_TYPE(uint32) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(has_data);
    };
#endif// !STRUCT_ONLY_LAST_UNION_MEMBER
    STRUCT_MIRROR_ITEM_CTRL(u32);
    STRUCT_MIRROR_TYPE(uint32) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(u32);
  } STRUCT_MIRROR_NAME(seh_ahw_header);
  STRUCT_MIRROR_FCNS_DECL(APV25_BLOCK);
};
...
STRUCT_MIRROR_TEMPLATE
class STRUCT_MIRROR_STRUCT(DIAMOND_SUBEVENT) : public STRUCT_MIRROR_BASE(unpack_subevent_base)
{
public:
  STRUCT_MIRROR_ITEM_CTRL_BASE(unpack_subevent_base);
  STRUCT_MIRROR_ITEM_CTRL(tdc);
  STRUCT_MIRROR_TYPE(VME_CAEN_V775) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(tdc);
  STRUCT_MIRROR_ITEM_CTRL(adc);
  STRUCT_MIRROR_TYPE(VME_CAEN_V775) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(adc);
  STRUCT_MIRROR_ITEM_CTRL(apv25);
  STRUCT_MIRROR_TYPE(APV25_BLOCK) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(apv25);
  STRUCT_MIRROR_ITEM_CTRL(subevent_info);
  STRUCT_MIRROR_TYPE(EXTERNAL_DATA_INFO) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(subevent_info);
  STRUCT_MIRROR_FCNS_DECL(DIAMOND_SUBEVENT);
};
#endif//USER_DEF_DIAMOND_SUBEVENT

#ifndef USER_DEF_DIAMOND_VME
STRUCT_MIRROR_TEMPLATE
class STRUCT_MIRROR_STRUCT(DIAMOND_VME) : public STRUCT_MIRROR_BASE(unpack_subevent_base)
{
public:
  STRUCT_MIRROR_ITEM_CTRL_BASE(unpack_subevent_base);
  STRUCT_MIRROR_ITEM_CTRL(tdc);
  ...
  STRUCT_MIRROR_FCNS_DECL(DIAMOND_VME);
};
...
public:
  ...
  STRUCT_MIRROR_TYPE(EXT_SST) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(sst[2]);
...
public:
  ...
  STRUCT_MIRROR_ITEM_CTRL(diamond);
  STRUCT_MIRROR_TYPE(DIAMOND_SUBEVENT) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(diamond);
  ...
  STRUCT_MIRROR_ITEM_CTRL(vme_diamond);
  STRUCT_MIRROR_TYPE(DIAMOND_VME) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(vme_diamond);
