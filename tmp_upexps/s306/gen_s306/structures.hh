/** BEGIN_STRUCTURES ***************************************************
 *
 * Event unpacker associated structures for APV25_BLOCK.
 *
...
// APV25_BLOCK(dsp_no)
#if !PACKER_CODE
# define DECLARED_UNPACK_APV25_BLOCK
class APV25_BLOCK
#else//PACKER_CODE
# define DECLARED_PACKER_APV25_BLOCK
class PACKER_APV25_BLOCK
#endif//PACKER_CODE
...
public:
  ...
  union
  {
    ...
    {
#if __BYTE_ORDER == __LITTLE_ENDIAN
      uint32 unnamed_0_0 : 1; // 0
      uint32 count32 : 11; // 1..11
      uint32 unnamed_12_14 : 3; // 12..14
      uint32 dummy : 1; // 15
      uint32 se_trigger_counter : 8; // 16..23
      uint32 trigger_number : 3; // 24..26
      uint32 unnamed_27_30 : 4; // 27..30
      uint32 has_data : 1; // 31
#endif
#if __BYTE_ORDER == __BIG_ENDIAN
      uint32 has_data : 1; // 31
      uint32 unnamed_27_30 : 4; // 27..30
...
template<typename __data_src_t>
  void __unpack(__data_src_t &__buffer,uint32 dsp_no);
template<typename __data_src_t>
  static bool __match(__data_src_t &__buffer,uint32 dsp_no);
  // void __clean();
# else//PACKER_CODE
template<typename __data_dest_t>
  void __packer(__data_dest_t &__buffer,uint32 dsp_no);
# endif//PACKER_CODE

  STRUCT_FCNS_DECL(APV25_BLOCK);
#endif//!__PSDC__
};
...
/** BEGIN_STRUCTURES ***************************************************
 *
 * Event unpacker associated structures for EXTERNAL_DATA_INFO.
 *
 * Do not edit - automatically generated.
 */
...
/** BEGIN_STRUCTURES ***************************************************
 *
 * Event unpacker associated structures for DIAMOND_SUBEVENT.
 *
 * Do not edit - automatically generated.
 */
...
#if !PACKER_CODE
# define DECLARED_UNPACK_DIAMOND_SUBEVENT
class DIAMOND_SUBEVENT
#else//PACKER_CODE
# define DECLARED_PACKER_DIAMOND_SUBEVENT
class PACKER_DIAMOND_SUBEVENT
#endif//PACKER_CODE
 : public unpack_subevent_base
{
public:
  ...
  // {
    //  0_31: 0x41505645;
  // }
  SINGLE(EXTERNAL_DATA_INFO,subevent_info);
...
# endif//PACKER_CODE
  ...
  STRUCT_FCNS_DECL(DIAMOND_SUBEVENT);
#endif//!__PSDC__
};
...
/** BEGIN_STRUCTURES ***************************************************
 *
 * Event unpacker associated structures for DIAMOND_VME.
 *
 * Do not edit - automatically generated.
 */
...
#if !PACKER_CODE
# define DECLARED_UNPACK_DIAMOND_VME
class DIAMOND_VME
#else//PACKER_CODE
# define DECLARED_PACKER_DIAMOND_VME
class PACKER_DIAMOND_VME
#endif//PACKER_CODE
 : public unpack_subevent_base
{
public:
...
SINGLE(DIAMOND_SUBEVENT,diamond);
...
SINGLE(DUMMY,acq);
SINGLE(DIAMOND_VME,vme_diamond);
