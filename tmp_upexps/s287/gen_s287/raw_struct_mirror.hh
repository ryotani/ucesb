...
#ifndef USER_DEF_raw_event_FGR
STRUCT_MIRROR_TEMPLATE
class STRUCT_MIRROR_STRUCT(raw_event_FGR)
{
public:
  STRUCT_MIRROR_ITEM_CTRL(E);
  STRUCT_MIRROR_TYPE(DATA12) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(E);
  STRUCT_MIRROR_ITEM_CTRL(T);
  STRUCT_MIRROR_TYPE(DATA12) STRUCT_MIRROR_TYPE_TEMPLATE_FULL STRUCT_MIRROR_NAME(T);
  STRUCT_MIRROR_FCNS_DECL(raw_event_FGR);
};
#endif//USER_DEF_raw_event_FGR
...
public:
  ...
  STRUCT_MIRROR_ITEM_CTRL(FGR);
  STRUCT_MIRROR_ITEM_CTRL_ARRAY(FGR__i0,,1);
  STRUCT_MIRROR_TYPE(raw_array_zero_suppress) < STRUCT_MIRROR_TYPE_TEMPLATE STRUCT_MIRROR_TEMPLATE_ARG(raw_event_FGR),STRUCT_MIRROR_TEMPLATE_ARG(raw_event_FGR),16> STRUCT_MIRROR_NAME(FGR[1]);
