...
FCNCALL_TEMPLATE
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(raw_event_FGR)::FCNCALL_NAME(raw_event_FGR)
{
  FCNCALL_INIT;
  // DATA12 E;
  {
...
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(raw_event)::FCNCALL_NAME(raw_event)
{
  ...
  // raw_array_zero_suppress<raw_event_FGR,raw_event_FGR,16> FGR[1];
  {
  FCNCALL_SUBNAME("FGR");
  FCNCALL_FOR(__i0,1)
  {
    FCNCALL_SUBINDEX(__i0);
    { FCNCALL_CALL_CTRL_WRAP_ARRAY(FGR__i0,,__i0,FGR[__i0].FCNCALL_CALL(FGR[__i0])); }
    FCNCALL_SUBINDEX_END(__i0);
  }
  FCNCALL_SUBNAME_END;
  }
