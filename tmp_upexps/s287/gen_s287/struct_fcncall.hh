...
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(LAND_CAMAC_CONVERTER)::FCNCALL_NAME(LAND_CAMAC_CONVERTER)
{
  ...
  // CAMAC_SILENA_4418 qSIA0416;
  {
  FCNCALL_SUBNAME("qSIA0416");
  { FCNCALL_CALL_CTRL_WRAP(qSIA0416,qSIA0416.FCNCALL_CALL(qSIA0416)); }
  FCNCALL_SUBNAME_END;
  }
  ...
  // CAMAC_PHILLIPS_7164 tPHI18573;
  {
  FCNCALL_SUBNAME("tPHI18573");
  { FCNCALL_CALL_CTRL_WRAP(tPHI18573,tPHI18573.FCNCALL_CALL(tPHI18573)); }
  FCNCALL_SUBNAME_END;
  }
  ...
  // CAMAC_SILENA_4418 tFRS120;
  {
  FCNCALL_SUBNAME("tFRS120");
  { FCNCALL_CALL_CTRL_WRAP(tFRS120,tFRS120.FCNCALL_CALL(tFRS120)); }
  FCNCALL_SUBNAME_END;
  }
