...
bool NTP64_TIME::__match(__data_src_t &__buffer)
{
  // UINT32 sec;
  uint32  __sec;
  READ_FROM_BUFFER(736,uint32 ,__sec);
  return true;
  return false;
}
...
bool NTP_MESSAGE::__match(__data_src_t &__buffer,uint32 id)
{
  ...
  READ_FROM_BUFFER_FULL(748,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(747,__header.id,id);
  MATCH_UNNAMED_BITS_ZERO(748,__header.u32,0x00fe0000);
  return true;
  return false;
}
...
bool RANDOM_TCAL_TSTAMP_CLOCK::__match(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER(804,uint32 ,__soft_latches);
  return true;
  return false;
}
...
bool RANDOM_TCAL::__match(__data_src_t &__buffer,uint32 id)
{
  ...
  READ_FROM_BUFFER_FULL(825,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(824,__header.id,id);
  MATCH_UNNAMED_BITS_ZERO(825,__header.u32,0x00f00000);
  return true;
  return false;
}
