...
void CROS3_REWRITE::__unpack(__data_src_t &__buffer,uint32 ccb_id)
{
  ...
  // {
    ...
    // 28_31: event_counter;
  // }
  READ_FROM_BUFFER_FULL(774,uint32 ,h1,h1.u32);
  CHECK_BITS_EQUAL(772,h1.ccb_id,ccb_id);
  CHECK_UNNAMED_BITS_ZERO(774,h1.u32,0x00080000);
  // if(h1.data)
  ...
  if (h1.data)
  {
    ...
    // {
      ...
      //    31: odd_length16;
    // }
    READ_FROM_BUFFER_FULL(789,uint32 ,h2,h2.u32);
    CHECK_UNNAMED_BITS_ZERO(789,h2.u32,0x7fc000ec);
    // if(h1.leading_edge)
    ...
    if (h1.leading_edge)
    {
      ...
      for (uint32 index = 0; index < (uint32) (static_cast<uint32>((h1.data_size - h2.odd_length16))); ++index)
      {
        ...
        READ_FROM_BUFFER_FULL(806,uint32 ,ch_data,ch_data.u32);
        {
          typedef __typeof__(*(&(data))) __array_t;
          typedef typename __array_t::item_t __item_t;
          __item_t &__item = data.insert_index(804,(index * 2));
        ...
        }
        {
          typedef __typeof__(*(&(data))) __array_t;
          typedef typename __array_t::item_t __item_t;
          __item_t &__item = data.insert_index(805,((index * 2) + 1));
      ...
      if (h2.odd_length16)
      {
        ...
        READ_FROM_BUFFER_FULL(821,uint32 ,ch_data_odd,ch_data_odd.u32);
        CHECK_BITS_EQUAL(817,ch_data_odd.start_slice2,255);
        CHECK_BITS_EQUAL(818,ch_data_odd.wire2,0);
        {
          typedef __typeof__(*(&(data))) __array_t;
          typedef typename __array_t::item_t __item_t;
          __item_t &__item = data.insert_index(820,((h1.data_size - 1) * 2));
    ...
    else
    {
      ...
      for (uint32 index = 0; index < (uint32) (h1.data_size); ++index)
      {
        ...
        READ_FROM_BUFFER_FULL(836,uint32 ,ch_data,ch_data.u32);
        CHECK_UNNAMED_BITS_ZERO(836,ch_data.u32,0xff000000);
        {
          typedef __typeof__(*(&(data))) __array_t;
          typedef typename __array_t::item_t __item_t;
          __item_t &__item = data.insert_index(835,index);
  ...
  else
  {
    ...
    if (h1.threshold_curve)
    {
      ...
      // {
        ...
        // 24_28: boards;
      // }
      READ_FROM_BUFFER_FULL(854,uint32 ,trc_h2,trc_h2.u32);
      CHECK_UNNAMED_BITS_ZERO(854,trc_h2.u32,0xe00000ec);
      ...
      for (uint32 board = 0; board < (uint32) (trc_h2.boards); ++board)
      {
        ...
        READ_FROM_BUFFER_FULL(866,uint32 ,trc_h3,trc_h3.u32);
        CHECK_UNNAMED_BITS_ZERO(866,trc_h3.u32,0x0f000000);
        ...
        for (uint32 index_thr = 0; index_thr < (uint32) (trc_h3.threshold_steps); ++index_thr)
        {
          ...
          for (uint32 index_wire2 = 0; index_wire2 < (uint32) (8); ++index_wire2)
          {
            ...
            READ_FROM_BUFFER_FULL(878,uint32 ,ch_counts,ch_counts.u32);
          }
        }
      }
    }
    ...
    else
    {
      ...
      READ_FROM_BUFFER_FULL(888,uint32 ,dummy_h2,dummy_h2.u32);
      CHECK_BITS_EQUAL(887,dummy_h2.unnamed_0_31,0);
    }
  }
}
...
{
  // UINT32 dummy_word;
  READ_FROM_BUFFER(1263,uint32 ,dummy_word);
}
...
void LAND_STD_VME::__unpack(__data_src_t &__buffer)
{
  ...
  // {
    ...
    //    31: has_time_stamp;
  // }
  READ_FROM_BUFFER_FULL(1207,uint32 ,failure,failure.u32);
  CHECK_UNNAMED_BITS_ZERO(1207,failure.u32,0x003fff00);
  // if(failure.has_continous_event_counter)

  if (failure.has_continous_event_counter)
  {
    // UINT32 continous_event_counter;
    READ_FROM_BUFFER(1210,uint32 ,continous_event_counter);
  }
  ...
  {
    // UINT32 time_stamp;
    READ_FROM_BUFFER(1214,uint32 ,time_stamp);
  }
  ...
  if (failure.has_clock_counter_stamp)
  {
    ...
    READ_FROM_BUFFER(1218,uint32 ,clock_counter_stamp);
  }
  ...
  {
    // UINT32 iped;
    READ_FROM_BUFFER(1222,uint32 ,iped);
  }
  ...
  {
    // UINT32 multi_events;
    READ_FROM_BUFFER(1226,uint32 ,multi_events);
  }
  ...
  if (failure.has_multi_trlo_ii_counter0)
  {
    ...
    READ_FROM_BUFFER(1230,uint32 ,multi_trlo_ii_counter0);
  }
  ...
  if (failure.has_multi_scaler_counter0)
  {
    ...
    READ_FROM_BUFFER(1234,uint32 ,multi_scaler_counter0);
  }
  ...
  if (failure.has_multi_adctdc_counter0)
  {
    ...
    READ_FROM_BUFFER(1238,uint32 ,multi_adctdc_counter0);
  }
}
...
{
  // UINT32 sec;
  READ_FROM_BUFFER(934,uint32 ,sec);
  // UINT32 frac;
  READ_FROM_BUFFER(935,uint32 ,frac);
}
...
void NTP_MESSAGE::__unpack(__data_src_t &__buffer,uint32 id)
{
  ...
  // {
    ...
    // 24_31: id = MATCH(id);
  // }
  READ_FROM_BUFFER_FULL(946,uint32 ,header,header.u32);
  CHECK_BITS_EQUAL(945,header.id,id);
  CHECK_UNNAMED_BITS_ZERO(946,header.u32,0x00fe0000);
  // MARK_COUNT(start);
  void *__mark_start = __buffer._data;
  // UINT32 server_id;
  READ_FROM_BUFFER(950,uint32 ,server_id);
  // UINT32 sspp
  // {
    //  0_07: precision;
    //  8_15: poll;
    ...
    // 30_31: leap;
  // }
  READ_FROM_BUFFER_FULL(962,uint32 ,sspp,sspp.u32);
  CHECK_BITS_EQUAL(960,sspp.version,3);
  CHECK_UNNAMED_BITS_ZERO(962,sspp.u32,0x00f00000);
  // UINT32 root_dly
  // {
    //  0_15: frac;
    // 16_31: sec;
  // }
  READ_FROM_BUFFER_FULL(968,uint32 ,root_dly,root_dly.u32);
  // UINT32 root_disp
  // {
    //  0_15: frac;
    // 16_31: sec;
  // }
  READ_FROM_BUFFER_FULL(973,uint32 ,root_disp,root_disp.u32);
  // UINT32 refid;
  READ_FROM_BUFFER(974,uint32 ,refid);
  // reftime = NTP64_TIME();
  UNPACK_DECL(976,NTP64_TIME,reftime);
  // origtime = NTP64_TIME();
  UNPACK_DECL(977,NTP64_TIME,origtime);
  // rectime = NTP64_TIME();
  UNPACK_DECL(978,NTP64_TIME,rectime);
  // tmittime = NTP64_TIME();
  UNPACK_DECL(979,NTP64_TIME,tmittime);
  // rxtime = NTP64_TIME();
  UNPACK_DECL(982,NTP64_TIME,rxtime);
  // if(header.quick_burst)

  if (header.quick_burst)
  {
    // orig2time = NTP64_TIME();
    UNPACK_DECL(986,NTP64_TIME,orig2time);
    // rec2time = NTP64_TIME();
    UNPACK_DECL(987,NTP64_TIME,rec2time);
    // tmit2time = NTP64_TIME();
    UNPACK_DECL(988,NTP64_TIME,tmit2time);
    // rx2time = NTP64_TIME();
    UNPACK_DECL(989,NTP64_TIME,rx2time);
  }
  // MARK_COUNT(end);
  void *__mark_end = __buffer._data;
  // CHECK_COUNT(header.word_count,start,end,0,4)
  CHECK_WORD_COUNT(994,header.word_count,start,end,0,4);
}
...
{
  // UINT32 soft_latches;
  READ_FROM_BUFFER(1002,uint32 ,soft_latches);
  // UINT32 hard_latches;
  READ_FROM_BUFFER(1003,uint32 ,hard_latches);
  // UINT32 clock_ticks;
  READ_FROM_BUFFER(1004,uint32 ,clock_ticks);
  // before = NTP64_TIME();
  UNPACK_DECL(1005,NTP64_TIME,before);
  // after = NTP64_TIME();
  UNPACK_DECL(1006,NTP64_TIME,after);
}
...
void RANDOM_TCAL::__unpack(__data_src_t &__buffer,uint32 id)
{
  ...
  // {
    ...
    // 24_31: id = MATCH(id);
  // }
  READ_FROM_BUFFER_FULL(1023,uint32 ,header,header.u32);
  CHECK_BITS_EQUAL(1022,header.id,id);
  CHECK_UNNAMED_BITS_ZERO(1023,header.u32,0x00f00000);
  // MARK_COUNT(start);
  void *__mark_start = __buffer._data;
  ...
  if (header.has_tstamp1)
  {
    ...
    UNPACK_DECL(1029,RANDOM_TCAL_TSTAMP_CLOCK,tstamp1);
  }
  ...
  if (header.has_tstamp2)
  {
    ...
    UNPACK_DECL(1033,RANDOM_TCAL_TSTAMP_CLOCK,tstamp2);
  }
  // MARK_COUNT(end);
  void *__mark_end = __buffer._data;
  // CHECK_COUNT(header.word_count,start,end,0,4)
  CHECK_WORD_COUNT(1038,header.word_count,start,end,0,4);
}
                                                   ...
                                                   ,uint32 siderem)
{
  ...
  // {
    ...
    // 28_31: sam = MATCH(sam);
  // }
  READ_FROM_BUFFER_FULL(715,uint32 ,header,header.u32);
  CHECK_BITS_EQUAL(712,header.siderem,siderem);
  CHECK_BITS_EQUAL(713,header.gtb,gtb);
  CHECK_BITS_EQUAL(714,header.sam,sam);
  ...
  for (uint32 index = 0; index < (uint32) (header.count); ++index)
  {
    ...
    READ_FROM_BUFFER_FULL(728,uint32 ,ch_data,ch_data.u32);
    CHECK_BITS_EQUAL(725,ch_data.unnamed_28_31,15);
    CHECK_UNNAMED_BITS_ZERO(728,ch_data.u32,0x0e00c000);
    {
      typedef __typeof__(*(&(data[ch_data.adc_no]))) __array_t;
      typedef typename __array_t::item_t __item_t;
      __item_t &__item = data[ch_data.adc_no].insert_index(727,ch_data.channel);
      __item.value = ch_data.value;
    }
  }
}
...
void SOFT_SCALER32::__unpack(__data_src_t &__buffer,uint32 channels)
{
  ...
  for (uint32 index = 0; index < (uint32) (channels); ++index)
  {
    ...
    READ_FROM_BUFFER_FULL(1067,uint32 ,ch_data,ch_data.u32);
    {
      typedef __typeof__(*(&(data))) __array_t;
      typedef typename __array_t::item_t __item_t;
      __item_t &__item = data.insert_index(1066,index);
      __item.value = ch_data.value;
    }
  }
}
...
void CROS3_REWRITE_SUBEVENT::__unpack(__data_src_t &__buffer)
{
  ...
  for ( ; ; )
  {
    ...
    {
      case 1:
        UNPACK_CHECK_NO_REVISIT(898,CROS3_REWRITE,ccb[0],__visited3,0);
        UNPACK_DECL(898,CROS3_REWRITE,ccb[0],/*ccb_id*/1);
        break;
      case 2:
        UNPACK_CHECK_NO_REVISIT(899,CROS3_REWRITE,ccb[1],__visited3,1);
        UNPACK_DECL(899,CROS3_REWRITE,ccb[1],/*ccb_id*/2);
        break;
    }
  }
}
...
void CROS3_SUBEVENT::__unpack(__data_src_t &__buffer)
{
  ...
  for ( ; ; )
  {
    ...
    __buffer.peeking();
    MATCH_DECL(752,__match_no,1,EXT_CROS3,ccb[0],/*ccb_id*/1);
    MATCH_DECL(753,__match_no,2,EXT_CROS3,ccb[1],/*ccb_id*/2);
    if (!__match_no) break;
    switch (__match_no)
    {
      case 1:
        UNPACK_CHECK_NO_REVISIT(752,EXT_CROS3,ccb[0],__visited4,0);
        UNPACK_DECL(752,EXT_CROS3,ccb[0],/*ccb_id*/1);
        break;
      case 2:
        UNPACK_CHECK_NO_REVISIT(753,EXT_CROS3,ccb[1],__visited4,1);
        UNPACK_DECL(753,EXT_CROS3,ccb[1],/*ccb_id*/2);
        break;
    }
  }
}
...
void DUMMY::__unpack(__data_src_t &__buffer)
{
  ...
  for ( ; ; )
  {
    ...
    {
    uint32 __match_peek;
    PEEK_FROM_BUFFER(1271,uint32,__match_peek);
    // differ = 00000000 :
...
{
  // UINT16 tpat;
  READ_FROM_BUFFER(908,uint16 ,tpat);
  // UINT16 tprev;
  READ_FROM_BUFFER(909,uint16 ,tprev);
  // UINT16 tnext;
  READ_FROM_BUFFER(910,uint16 ,tnext);
  // UINT16 tprev2;
  READ_FROM_BUFFER(911,uint16 ,tprev2);
  // if(EXTERNAL has_data)

  if (has_data())
  {
    // aPHI14829 = CAMAC_PHILLIPS_7164(channels=16,mark_channel_no=1);
    UNPACK_DECL(918,CAMAC_PHILLIPS_7164,aPHI14829,/*channels*/16,/*mark_channel_no*/1);
    // qSIA0429 = CAMAC_SILENA_4418(channels=8,mark_channel_no=0);
    UNPACK_DECL(919,CAMAC_SILENA_4418,qSIA0429,/*channels*/8,/*mark_channel_no*/0);
    // qSIA0480 = CAMAC_SILENA_4418(channels=8,mark_channel_no=0);
    UNPACK_DECL(920,CAMAC_SILENA_4418,qSIA0480,/*channels*/8,/*mark_channel_no*/0);
    // tSIA0400 = CAMAC_SILENA_4418(channels=8,mark_channel_no=0);
    UNPACK_DECL(921,CAMAC_SILENA_4418,tSIA0400,/*channels*/8,/*mark_channel_no*/0);
    // tC_FRS120 = CAMAC_SILENA_4418(channels=6,mark_channel_no=0);
    UNPACK_DECL(922,CAMAC_SILENA_4418,tC_FRS120,/*channels*/6,/*mark_channel_no*/0);
    // tSIA0426 = CAMAC_SILENA_4418(channels=4,mark_channel_no=0);
    UNPACK_DECL(923,CAMAC_SILENA_4418,tSIA0426,/*channels*/4,/*mark_channel_no*/0);
    // qSIA0458 = CAMAC_SILENA_4418(channels=8,mark_channel_no=0);
    UNPACK_DECL(924,CAMAC_SILENA_4418,qSIA0458,/*channels*/8,/*mark_channel_no*/0);
  }
}
...
void LAND_CAMAC_SCALER::__unpack(__data_src_t &__buffer)
{
  ...
  UNPACK_DECL(1073,CAMAC_LECROY_4434,scaler0,/*channels*/32);
  // scaler1 = CAMAC_LECROY_4434(channels=32);
  UNPACK_DECL(1074,CAMAC_LECROY_4434,scaler1,/*channels*/32);
  // scaler2 = CAMAC_LECROY_4434(channels=32);
  UNPACK_DECL(1075,CAMAC_LECROY_4434,scaler2,/*channels*/32);
  // if(EXTERNAL has_timestamp)

  if (has_timestamp())
  {
    // UINT32 timestamp;
    READ_FROM_BUFFER(1084,uint32 ,timestamp);
    // UINT32 endianess
    // {
      //  0_31: 0x87654321;
    // }
    READ_FROM_BUFFER_FULL(1085,uint32 ,endianess,endianess.u32);
    CHECK_BITS_EQUAL(1085,endianess.unnamed_0_31,0x87654321);
  }
}
...
{
  // UINT32 info;
  READ_FROM_BUFFER(1044,uint32 ,info);
  // select several
  ...
  for ( ; ; )
  {
    ...
    {
    uint32 __match_peek;
    PEEK_FROM_BUFFER(1050,uint32,__match_peek);
    // differ = 08000000 : 27
    ...
    {
      case 1:
        UNPACK_DECL(1048,RANDOM_TCAL,rtcal,/*id*/231);
        break;
      case 2:
        UNPACK_DECL(1049,NTP_MESSAGE,ntp,/*id*/239);
        break;
    }
  }
}
...
void LAND_FASTBUS1::__unpack(__data_src_t &__buffer)
{
  ...
  for ( ; ; )
  {
    ...
    {
    uint32 __match_peek;
    PEEK_FROM_BUFFER(1156,uint32,__match_peek);
    ...
    {
      case 1:
        UNPACK_DECL(1141,FASTBUS_LECROY_1885,Q47342,/*geom*/7,/*channels*/96);
        break;
      case 2:
        UNPACK_DECL(1142,FASTBUS_LECROY_1885,Q11111,/*geom*/8,/*channels*/96);
        break;
      case 3:
        UNPACK_DECL(1143,FASTBUS_LECROY_1885,Q46848,/*geom*/10,/*channels*/96);
        break;
      case 4:
        UNPACK_DECL(1144,FASTBUS_LECROY_1885,Q47315,/*geom*/11,/*channels*/96);
        break;
      case 5:
        UNPACK_DECL(1145,FASTBUS_LECROY_1885,Q17320,/*geom*/13,/*channels*/96);
        break;
      case 6:
        UNPACK_DECL(1146,FASTBUS_LECROY_1885,Q15372,/*geom*/15,/*channels*/96);
        break;
      case 7:
        UNPACK_DECL(1147,FASTBUS_LECROY_1885,Q46962,/*geom*/16,/*channels*/96);
        break;
      case 8:
        UNPACK_DECL(1148,FASTBUS_LECROY_1885,Q46993,/*geom*/18,/*channels*/96);
        break;
      case 9:
        UNPACK_DECL(1149,FASTBUS_LECROY_1885,Q15358,/*geom*/20,/*channels*/96);
        break;
      case 10:
        UNPACK_DECL(1150,FASTBUS_LECROY_1885,Q47264,/*geom*/23,/*channels*/96);
        break;
      case 11:
        UNPACK_DECL(1151,FASTBUS_LECROY_1875,T81855,/*geom*/3,/*channels*/64);
        break;
      case 12:
        UNPACK_DECL(1152,FASTBUS_LECROY_1875,T87044,/*geom*/4,/*channels*/64);
        break;
      case 13:
        UNPACK_DECL(1153,FASTBUS_LECROY_1875,T87024,/*geom*/5,/*channels*/64);
        break;
      case 14:
        UNPACK_DECL(1154,FASTBUS_LECROY_1875,T81800,/*geom*/6,/*channels*/64);
        break;
    }
  }
}
...
void LAND_FASTBUS2::__unpack(__data_src_t &__buffer)
{
  ...
  for ( ; ; )
  {
    ...
    {
      case 1:
        UNPACK_DECL(1169,FASTBUS_LECROY_1875,T87047,/*geom*/1,/*channels*/64);
        break;
      case 2:
        UNPACK_DECL(1170,FASTBUS_LECROY_1875,T48854,/*geom*/2,/*channels*/64);
        break;
      case 3:
        UNPACK_DECL(1171,FASTBUS_LECROY_1875,T81808,/*geom*/3,/*channels*/64);
        break;
      case 4:
        UNPACK_DECL(1172,FASTBUS_LECROY_1875,T81859,/*geom*/4,/*channels*/64);
        break;
      case 5:
        UNPACK_DECL(1173,FASTBUS_LECROY_1875,T81795,/*geom*/5,/*channels*/64);
        break;
      case 6:
        UNPACK_DECL(1174,FASTBUS_LECROY_1875,T81806,/*geom*/6,/*channels*/64);
        break;
      case 7:
        UNPACK_DECL(1175,FASTBUS_LECROY_1875,T48834,/*geom*/7,/*channels*/64);
        break;
    }
  }
}
...
void LAND_FASTBUS_ERROR::__unpack(__data_src_t &__buffer)
{
  ...
  // {
    ...
    //    16: init_error;
  // }
  READ_FROM_BUFFER_FULL(1107,uint32 ,error_code,error_code.u32);
  CHECK_UNNAMED_BITS_ZERO(1107,error_code.u32,0xfffefff0);
  // UINT32 error_num;
  READ_FROM_BUFFER(1108,uint32 ,error_num);
}
...
void LAND_FASTBUS_ERROR_NGF::__unpack(__data_src_t &__buffer)
{
  ...
  // {
    //  0_31: 0x10000000;
  // }
  READ_FROM_BUFFER_FULL(1116,uint32 ,magic,magic.u32);
  CHECK_BITS_EQUAL(1115,magic.unnamed_0_31,0x10000000);
  // UINT32 error_code
  // {
    //     0: error;
    //     1: uninitialized;
    ...
    //     9: word_lost;
  // }
  READ_FROM_BUFFER_FULL(1129,uint32 ,error_code,error_code.u32);
  CHECK_UNNAMED_BITS_ZERO(1129,error_code.u32,0xfffffc00);
}
...
{
  // vme = LAND_STD_VME();
  UNPACK_DECL(1245,LAND_STD_VME,vme);
  // select several

    // tdc775 = VME_CAEN_V775(geom=16,crate=130);
    // qdc792 = VME_CAEN_V775(geom=0,crate=1);
  ...
  for ( ; ; )
  {
    if (__buffer.empty()) break;
    int __match_no = 0;
    // optimized match 1: VME_CAEN_V775 tdc775: (s32) => (0xffffc0ff,0x82820000)
    // optimized match 2: VME_CAEN_V775 qdc792: (s32) => (0xffffc0ff,0x02010000)
    ...
    if (__match_peek & 0x40000000) {
      MATCH_DECL_QUICK(1253,__match_no,3,scaler[0],__match_peek,0xff000000,0xf4000000);
      MATCH_DECL_QUICK(1254,__match_no,4,scaler[1],__match_peek,0xff000000,0xfc000000);
    } else {
      MATCH_DECL_QUICK(1250,__match_no,1,tdc775,__match_peek,0xffffc0ff,0x82820000);
      MATCH_DECL_QUICK(1252,__match_no,2,qdc792,__match_peek,0xffffc0ff,0x02010000);
    }
    // last_subevent_item = 1
    }
    if (!__match_no) break;
    ...
    {
      case 1:
        UNPACK_DECL(1250,VME_CAEN_V775,tdc775,/*geom*/16,/*crate*/130);
        break;
      case 2:
        UNPACK_DECL(1252,VME_CAEN_V775,qdc792,/*geom*/0,/*crate*/1);
        break;
      case 3:
        UNPACK_DECL(1253,VME_CAEN_V830,scaler[0],/*geom*/30);
        break;
      case 4:
        UNPACK_DECL(1254,VME_CAEN_V830,scaler[1],/*geom*/31);
        break;
    }
  }
}
...
void SIDEREM01_VME::__unpack(__data_src_t &__buffer)
{
  ...
  for ( ; ; )
  {
    if (__buffer.empty()) break;
    int __match_no = 0;
    // optimized match 1: SIDEREM_BLOCK sst[0]: (s32) => (0xfff00000,0x50100000)
    // optimized match 2: SIDEREM_BLOCK sst[1]: (s32) => (0xfff00000,0x50200000)
    // optimized match 3: SIDEREM_BLOCK sst[2]: (s32) => (0xfff00000,0x50300000)
    // optimized match 4: SIDEREM_BLOCK sst[3]: (s32) => (0xfff00000,0x51100000)
    // optimized match 5: SIDEREM_BLOCK sst[4]: (s32) => (0xfff00000,0x51200000)
    {
    uint32 __match_peek;
    PEEK_FROM_BUFFER(741,uint32,__match_peek);
    // differ = 01300000 : 20 21 24
    uint32 __match_index = 0 | /* 20,21 */ ((__match_peek >> 20) & 0x00000003) | /* 24,24 */ ((__match_peek >> 22) & 0x00000004);
    static const sint8 __match_index_array[8] = { 0, 1, 2, 3, 0, 4, 5, 0, };
    __match_no = __match_index_array[__match_index];
    // last_subevent_item = 1
    }
    if (!__match_no) break;
    ...
    {
      case 1:
        UNPACK_DECL(736,SIDEREM_BLOCK,sst[0],/*sam*/5,/*gtb*/0,/*siderem*/1);
        break;
      case 2:
        UNPACK_DECL(737,SIDEREM_BLOCK,sst[1],/*sam*/5,/*gtb*/0,/*siderem*/2);
        break;
      case 3:
        UNPACK_DECL(738,SIDEREM_BLOCK,sst[2],/*sam*/5,/*gtb*/0,/*siderem*/3);
        break;
      case 4:
        UNPACK_DECL(739,SIDEREM_BLOCK,sst[3],/*sam*/5,/*gtb*/1,/*siderem*/1);
        break;
      case 5:
        UNPACK_DECL(740,SIDEREM_BLOCK,sst[4],/*sam*/5,/*gtb*/1,/*siderem*/2);
        break;
    }
  }
}
