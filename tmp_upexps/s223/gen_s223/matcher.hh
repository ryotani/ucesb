...
bool CROS3_REWRITE::__match(__data_src_t &__buffer,uint32 ccb_id)
{
  ...
  READ_FROM_BUFFER_FULL(774,uint32 ,h1,__h1.u32);
  MATCH_BITS_EQUAL(772,__h1.ccb_id,ccb_id);
  MATCH_UNNAMED_BITS_ZERO(774,__h1.u32,0x00080000);
  return true;
  return false;
}
...
bool DUMMY_WORD::__match(__data_src_t &__buffer)
{
  // UINT32 dummy_word;
  uint32  __dummy_word;
  READ_FROM_BUFFER(1263,uint32 ,__dummy_word);
  return true;
  return false;
}
...
bool LAND_STD_VME::__match(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER_FULL(1207,uint32 ,failure,__failure.u32);
  MATCH_UNNAMED_BITS_ZERO(1207,__failure.u32,0x003fff00);
  return true;
  return false;
}
...
bool NTP64_TIME::__match(__data_src_t &__buffer)
{
  // UINT32 sec;
  uint32  __sec;
  READ_FROM_BUFFER(934,uint32 ,__sec);
  return true;
  return false;
}
...
bool NTP_MESSAGE::__match(__data_src_t &__buffer,uint32 id)
{
  ...
  READ_FROM_BUFFER_FULL(946,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(945,__header.id,id);
  MATCH_UNNAMED_BITS_ZERO(946,__header.u32,0x00fe0000);
  return true;
  return false;
}
...
bool RANDOM_TCAL_TSTAMP_CLOCK::__match(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER(1002,uint32 ,__soft_latches);
  return true;
  return false;
}
...
bool RANDOM_TCAL::__match(__data_src_t &__buffer,uint32 id)
{
  ...
  READ_FROM_BUFFER_FULL(1023,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(1022,__header.id,id);
  MATCH_UNNAMED_BITS_ZERO(1023,__header.u32,0x00f00000);
  return true;
  return false;
}
                                                  ...
                                                  ,uint32 siderem)
{
  ...
  READ_FROM_BUFFER_FULL(715,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(712,__header.siderem,siderem);
  MATCH_BITS_EQUAL(713,__header.gtb,gtb);
  MATCH_BITS_EQUAL(714,__header.sam,sam);
  return true;
  return false;
}
