...
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(LAND_VME)::FCNCALL_NAME(LAND_VME)
{
  FCNCALL_INIT;
  FCNCALL_CALL_CTRL_WRAP(unpack_subevent_base,FCNCALL_CLASS_NAME(unpack_subevent_base)::FCNCALL_CALL_BASE());
  // VME_CAEN_V775 tdc775;
  {
  FCNCALL_SUBNAME("tdc775");
  { FCNCALL_CALL_CTRL_WRAP(tdc775,tdc775.FCNCALL_CALL(tdc775)); }
  FCNCALL_SUBNAME_END;
  }
  ...
  // VME_CAEN_V775 qdc792;
  {
  FCNCALL_SUBNAME("qdc792");
  { FCNCALL_CALL_CTRL_WRAP(qdc792,qdc792.FCNCALL_CALL(qdc792)); }
  FCNCALL_SUBNAME_END;
  }
  // LAND_STD_VME vme;
  {
...
FCNCALL_RET_TYPE FCNCALL_CLASS_NAME(unpack_event)::FCNCALL_NAME(unpack_event)
{
  ...
  // DUMMY camac_scalers_d;
  {
  FCNCALL_SUBNAME("camac_scalers_d");
  { FCNCALL_CALL_CTRL_WRAP(camac_scalers_d,camac_scalers_d.FCNCALL_CALL(camac_scalers_d)); }
  FCNCALL_SUBNAME_END;
  }
