...
void PACKER_NTP_MESSAGE::__packer(__data_dest_t &__buffer,uint32 id)
{
  ...
  // UINT32 refid;
  // reftime = NTP64_TIME();
  PACK_DECL(976,NTP64_TIME,reftime);
  // origtime = NTP64_TIME();
  PACK_DECL(977,NTP64_TIME,origtime);
  // rectime = NTP64_TIME();
  PACK_DECL(978,NTP64_TIME,rectime);
  // tmittime = NTP64_TIME();
  PACK_DECL(979,NTP64_TIME,tmittime);
  // rxtime = NTP64_TIME();
  PACK_DECL(982,NTP64_TIME,rxtime);
  // if(header.quick_burst)

  if (header.quick_burst)
  {
    // orig2time = NTP64_TIME();
    PACK_DECL(986,NTP64_TIME,orig2time);
    // rec2time = NTP64_TIME();
    PACK_DECL(987,NTP64_TIME,rec2time);
    // tmit2time = NTP64_TIME();
    PACK_DECL(988,NTP64_TIME,tmit2time);
    // rx2time = NTP64_TIME();
    PACK_DECL(989,NTP64_TIME,rx2time);
  }
  // MARK_COUNT(end);
...
void PACKER_RANDOM_TCAL_TSTAMP_CLOCK::__packer(__data_dest_t &__buffer)
{
  ...
  // UINT32 clock_ticks;
  // before = NTP64_TIME();
  PACK_DECL(1005,NTP64_TIME,before);
  // after = NTP64_TIME();
  PACK_DECL(1006,NTP64_TIME,after);
}
...
void PACKER_RANDOM_TCAL::__packer(__data_dest_t &__buffer,uint32 id)
{
  ...
  if (header.has_tstamp1)
  {
    ...
    PACK_DECL(1029,RANDOM_TCAL_TSTAMP_CLOCK,tstamp1);
  }
  ...
  if (header.has_tstamp2)
  {
    ...
    PACK_DECL(1033,RANDOM_TCAL_TSTAMP_CLOCK,tstamp2);
  }
  // MARK_COUNT(end);
  void *__mark_end = __buffer._offset;
  // CHECK_COUNT(header.word_count,start,end,0,4)
...
void PACKER_CROS3_REWRITE_SUBEVENT::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(898,CROS3_REWRITE,ccb[0],/*ccb_id*/1);
    PACK_DECL(899,CROS3_REWRITE,ccb[1],/*ccb_id*/2);
  }
}
...
void PACKER_CROS3_SUBEVENT::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(752,EXT_CROS3,ccb[0],/*ccb_id*/1);
    PACK_DECL(753,EXT_CROS3,ccb[1],/*ccb_id*/2);
  }
}
...
void PACKER_LAND_CAMAC_CONVERTER::__packer(__data_dest_t &__buffer)
{
  ...
  if (has_data())
  {
    ...
    PACK_DECL(918,CAMAC_PHILLIPS_7164,aPHI14829,/*channels*/16,/*mark_channel_no*/1);
    // qSIA0429 = CAMAC_SILENA_4418(channels=8,mark_channel_no=0);
    PACK_DECL(919,CAMAC_SILENA_4418,qSIA0429,/*channels*/8,/*mark_channel_no*/0);
    // qSIA0480 = CAMAC_SILENA_4418(channels=8,mark_channel_no=0);
    PACK_DECL(920,CAMAC_SILENA_4418,qSIA0480,/*channels*/8,/*mark_channel_no*/0);
    // tSIA0400 = CAMAC_SILENA_4418(channels=8,mark_channel_no=0);
    PACK_DECL(921,CAMAC_SILENA_4418,tSIA0400,/*channels*/8,/*mark_channel_no*/0);
    // tC_FRS120 = CAMAC_SILENA_4418(channels=6,mark_channel_no=0);
    PACK_DECL(922,CAMAC_SILENA_4418,tC_FRS120,/*channels*/6,/*mark_channel_no*/0);
    // tSIA0426 = CAMAC_SILENA_4418(channels=4,mark_channel_no=0);
    PACK_DECL(923,CAMAC_SILENA_4418,tSIA0426,/*channels*/4,/*mark_channel_no*/0);
    // qSIA0458 = CAMAC_SILENA_4418(channels=8,mark_channel_no=0);
    PACK_DECL(924,CAMAC_SILENA_4418,qSIA0458,/*channels*/8,/*mark_channel_no*/0);
  }
}
...
void PACKER_LAND_CAMAC_SCALER::__packer(__data_dest_t &__buffer)
{
  ...
  PACK_DECL(1073,CAMAC_LECROY_4434,scaler0,/*channels*/32);
  // scaler1 = CAMAC_LECROY_4434(channels=32);
  PACK_DECL(1074,CAMAC_LECROY_4434,scaler1,/*channels*/32);
  // scaler2 = CAMAC_LECROY_4434(channels=32);
  PACK_DECL(1075,CAMAC_LECROY_4434,scaler2,/*channels*/32);
...
void PACKER_LAND_CAMAC_TCAL_INFO::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(1048,RANDOM_TCAL,rtcal,/*id*/231);
    PACK_DECL(1049,NTP_MESSAGE,ntp,/*id*/239);
  }
}
...
void PACKER_LAND_FASTBUS1::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(1141,FASTBUS_LECROY_1885,Q47342,/*geom*/7,/*channels*/96);
    PACK_DECL(1142,FASTBUS_LECROY_1885,Q11111,/*geom*/8,/*channels*/96);
    PACK_DECL(1143,FASTBUS_LECROY_1885,Q46848,/*geom*/10,/*channels*/96);
    PACK_DECL(1144,FASTBUS_LECROY_1885,Q47315,/*geom*/11,/*channels*/96);
    PACK_DECL(1145,FASTBUS_LECROY_1885,Q17320,/*geom*/13,/*channels*/96);
    PACK_DECL(1146,FASTBUS_LECROY_1885,Q15372,/*geom*/15,/*channels*/96);
    PACK_DECL(1147,FASTBUS_LECROY_1885,Q46962,/*geom*/16,/*channels*/96);
    PACK_DECL(1148,FASTBUS_LECROY_1885,Q46993,/*geom*/18,/*channels*/96);
    PACK_DECL(1149,FASTBUS_LECROY_1885,Q15358,/*geom*/20,/*channels*/96);
    PACK_DECL(1150,FASTBUS_LECROY_1885,Q47264,/*geom*/23,/*channels*/96);
    PACK_DECL(1151,FASTBUS_LECROY_1875,T81855,/*geom*/3,/*channels*/64);
    PACK_DECL(1152,FASTBUS_LECROY_1875,T87044,/*geom*/4,/*channels*/64);
    PACK_DECL(1153,FASTBUS_LECROY_1875,T87024,/*geom*/5,/*channels*/64);
    PACK_DECL(1154,FASTBUS_LECROY_1875,T81800,/*geom*/6,/*channels*/64);
  }
}
...
void PACKER_LAND_FASTBUS2::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(1169,FASTBUS_LECROY_1875,T87047,/*geom*/1,/*channels*/64);
    PACK_DECL(1170,FASTBUS_LECROY_1875,T48854,/*geom*/2,/*channels*/64);
    PACK_DECL(1171,FASTBUS_LECROY_1875,T81808,/*geom*/3,/*channels*/64);
    PACK_DECL(1172,FASTBUS_LECROY_1875,T81859,/*geom*/4,/*channels*/64);
    PACK_DECL(1173,FASTBUS_LECROY_1875,T81795,/*geom*/5,/*channels*/64);
    PACK_DECL(1174,FASTBUS_LECROY_1875,T81806,/*geom*/6,/*channels*/64);
    PACK_DECL(1175,FASTBUS_LECROY_1875,T48834,/*geom*/7,/*channels*/64);
  }
}
...
{
  // vme = LAND_STD_VME();
  PACK_DECL(1245,LAND_STD_VME,vme);
  // select several
  ...
  {
    PACK_DECL(1250,VME_CAEN_V775,tdc775,/*geom*/16,/*crate*/130);
    PACK_DECL(1252,VME_CAEN_V775,qdc792,/*geom*/0,/*crate*/1);
    PACK_DECL(1253,VME_CAEN_V830,scaler[0],/*geom*/30);
    PACK_DECL(1254,VME_CAEN_V830,scaler[1],/*geom*/31);
  }
}
...
void PACKER_SIDEREM01_VME::__packer(__data_dest_t &__buffer)
{
  ...
  {
    PACK_DECL(736,SIDEREM_BLOCK,sst[0],/*sam*/5,/*gtb*/0,/*siderem*/1);
    PACK_DECL(737,SIDEREM_BLOCK,sst[1],/*sam*/5,/*gtb*/0,/*siderem*/2);
    PACK_DECL(738,SIDEREM_BLOCK,sst[2],/*sam*/5,/*gtb*/0,/*siderem*/3);
    PACK_DECL(739,SIDEREM_BLOCK,sst[3],/*sam*/5,/*gtb*/1,/*siderem*/1);
    PACK_DECL(740,SIDEREM_BLOCK,sst[4],/*sam*/5,/*gtb*/1,/*siderem*/2);
  }
}
