...
bool DUMMY_WORD::__match(__data_src_t &__buffer)
{
  // UINT32 dummy_word;
  uint32  __dummy_word;
  READ_FROM_BUFFER(1027,uint32 ,__dummy_word);
  return true;
  return false;
}
...
bool NTP64_TIME::__match(__data_src_t &__buffer)
{
  // UINT32 sec;
  uint32  __sec;
  READ_FROM_BUFFER(775,uint32 ,__sec);
  return true;
  return false;
}
...
bool NTP_MESSAGE::__match(__data_src_t &__buffer,uint32 id)
{
  ...
  READ_FROM_BUFFER_FULL(787,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(786,__header.id,id);
  MATCH_UNNAMED_BITS_ZERO(787,__header.u32,0x00fe0000);
  return true;
  return false;
}
...
bool RANDOM_TCAL_TSTAMP_CLOCK::__match(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER(843,uint32 ,__soft_latches);
  return true;
  return false;
}
...
bool RANDOM_TCAL::__match(__data_src_t &__buffer,uint32 id)
{
  ...
  READ_FROM_BUFFER_FULL(864,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(863,__header.id,id);
  MATCH_UNNAMED_BITS_ZERO(864,__header.u32,0x00f00000);
  return true;
  return false;
}
                                                  ...
                                                  ,uint32 siderem)
{
  ...
  READ_FROM_BUFFER_FULL(716,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(713,__header.siderem,siderem);
  MATCH_BITS_EQUAL(714,__header.gtb,gtb);
  MATCH_BITS_EQUAL(715,__header.sam,sam);
  return true;
  return false;
}
