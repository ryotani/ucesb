  ...
  select several
    {
      ...
      tdc775LENA = VME_CAEN_V775(geom=31,crate=132);
      qdc862LENA = VME_CAEN_V792(geom=31,crate=3);

      LaBr_madc0 = VME_MESYTEC_MADC32(geom=2);
      LaBr_tdc775 = VME_CAEN_V775(geom=31,crate=134);
  ...
  select several
    {
      ...
      qdc792NTF = VME_CAEN_V792(geom=31,crate=133);
 
      qdc792GFI1 = VME_CAEN_V792(geom=31,crate=7);
      qdc792GFI2 = VME_CAEN_V792(geom=31,crate=8);
      qdc792GFI12 = VME_CAEN_V792(geom=31,crate=9);
    }  
}
