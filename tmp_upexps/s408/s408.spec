...
EVENT
{
  ...
  vme4     = MASTER_VME(type = SUBEVENT_VME,
                        subtype = SUBEVENT_VME_DATA8800,subcrate=4);
  vme1     = VME_CRATE1(type = SUBEVENT_VME,
                        subtype = SUBEVENT_VME_DATA8800,subcrate=1);
  vme2     = VME_CRATE2(type = SUBEVENT_VME,
                        subtype = SUBEVENT_VME_DATA8800,subcrate=2);
