...
bool NTP64_TIME::__match(__data_src_t &__buffer)
{
  // UINT32 sec;
  uint32  __sec;
  READ_FROM_BUFFER(735,uint32 ,__sec);
  return true;
  return false;
}
...
bool NTP_MESSAGE::__match(__data_src_t &__buffer,uint32 id)
{
  ...
  READ_FROM_BUFFER_FULL(747,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(746,__header.id,id);
  MATCH_UNNAMED_BITS_ZERO(747,__header.u32,0x00fe0000);
  return true;
  return false;
}
...
bool RANDOM_TCAL_TSTAMP_CLOCK::__match(__data_src_t &__buffer)
{
  ...
  READ_FROM_BUFFER(803,uint32 ,__soft_latches);
  return true;
  return false;
}
...
bool RANDOM_TCAL::__match(__data_src_t &__buffer,uint32 id)
{
  ...
  READ_FROM_BUFFER_FULL(824,uint32 ,header,__header.u32);
  MATCH_BITS_EQUAL(823,__header.id,id);
  MATCH_UNNAMED_BITS_ZERO(824,__header.u32,0x00f00000);
  return true;
  return false;
}
