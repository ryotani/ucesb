...
FEBEX3_CALIFA_BASE(){
  ...
  MEMBER(DATA16 energy[NUM_FEBEX_MODULES*CHANNELS_PER_FEBEX]  ZERO_SUPPRESS);
  MEMBER(DATA32 ts_lsb[NUM_FEBEX_MODULES*CHANNELS_PER_FEBEX]   ZERO_SUPPRESS);
  MEMBER(DATA32 ts_msb[NUM_FEBEX_MODULES*CHANNELS_PER_FEBEX]   ZERO_SUPPRESS);
  MEMBER(DATA16 n_f[NUM_FEBEX_MODULES*CHANNELS_PER_FEBEX]   ZERO_SUPPRESS);
  MEMBER(DATA16 n_s[NUM_FEBEX_MODULES*CHANNELS_PER_FEBEX]   ZERO_SUPPRESS);
  ...
  if(DATASIZE.sizebytes>0){
	...
	UINT32 timestamp_msb NOENCODE;
      ...
      16_31: ns;
        ...
        ENCODE(energy[HEADER.module_id*CHANNELS_PER_FEBEX+HEADER.submemory_id], (value=ENERGY_VALUE.eneval));
        ENCODE(ts_lsb[HEADER.module_id*CHANNELS_PER_FEBEX+HEADER.submemory_id], (value=timestamp_lsb));
        ENCODE(ts_msb[HEADER.module_id*CHANNELS_PER_FEBEX+HEADER.submemory_id], (value=timestamp_msb));
        ENCODE(n_f[HEADER.module_id*CHANNELS_PER_FEBEX+HEADER.submemory_id], (value=INTEGRAL_VALUE.nf));
        ENCODE(n_s[HEADER.module_id*CHANNELS_PER_FEBEX+HEADER.submemory_id], (value=INTEGRAL_VALUE.ns));
